...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    public MaterialCheckBox(Context context, AttributeSet attributeSet, int i) {
        ...
        post(new Runnable() { // from class: com.google.android.material.checkbox.MaterialCheckBox$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m193xdf87d0bf();
            }
        });
    }

    /* JADX INFO: renamed from: lambda$new$0$com-google-android-material-checkbox-MaterialCheckBox, reason: not valid java name */
    /* synthetic */ void m193xdf87d0bf() {
    ...
    public void setCheckedState(int i) {
        AutofillManager autofillManagerM203m;
        ...
        if (this.checkedState != i) {
            ...
            if (Build.VERSION.SDK_INT >= 26 && (autofillManagerM203m = Chip$$ExternalSyntheticApiModelOutline0.m203m(getContext().getSystemService(Chip$$ExternalSyntheticApiModelOutline0.m207m()))) != null) {
                autofillManagerM203m.notifyValueChanged(this);
            }
    ...
    private void setUpDefaultButtonDrawableAnimationIfNeeded() {
        if (this.usingMaterialButtonDrawable) {
            ...
            if (Build.VERSION.SDK_INT < 24 || !Chip$$ExternalSyntheticApiModelOutline0.m$1(this.buttonDrawable) || this.transitionToUnchecked == null) {
                return;
            }
            Chip$$ExternalSyntheticApiModelOutline0.m((Object) this.buttonDrawable).addTransition(R.id.checked, R.id.unchecked, this.transitionToUnchecked, false);
            Chip$$ExternalSyntheticApiModelOutline0.m((Object) this.buttonDrawable).addTransition(R.id.indeterminate, R.id.unchecked, this.transitionToUnchecked, false);
        }
    }
    ...
    private boolean isButtonDrawableLegacy(TintTypedArray tintTypedArray) {
        ...
        return Build.VERSION.SDK_INT < 21 ? resourceId == R.drawable.abc_btn_check_material && resourceId2 == R.drawable.abc_btn_check_material_anim : resourceId == FRAMEWORK_BUTTON_DRAWABLE_RES_ID && resourceId2 == 0;
    }
