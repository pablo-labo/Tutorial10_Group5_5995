...
class MaterialButtonHelper {
    ...
    void setRippleColor(ColorStateList colorStateList) {
        if (this.rippleColor != colorStateList) {
            ...
            if (z && ComponentDialog$$ExternalSyntheticApiModelOutline0.m24m((Object) this.materialButton.getBackground())) {
                Chip$$ExternalSyntheticApiModelOutline0.m198m((Object) this.materialButton.getBackground()).setColor(RippleUtils.sanitizeRippleDrawableColor(colorStateList));
            } else {
