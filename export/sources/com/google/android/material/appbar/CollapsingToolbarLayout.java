...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    private static boolean isToolbar(View view) {
        return (view instanceof Toolbar) || (Build.VERSION.SDK_INT >= 21 && Chip$$ExternalSyntheticApiModelOutline0.m210m((Object) view));
    }
    ...
    private void updateCollapsedBounds(boolean z) {
        ...
        } else if (Build.VERSION.SDK_INT < 24 || !Chip$$ExternalSyntheticApiModelOutline0.m210m((Object) this.toolbar)) {
            titleMarginStart = 0;
            titleMarginBottom = 0;
            titleMarginEnd = 0;
            titleMarginTop = 0;
        } else {
            android.widget.Toolbar toolbarM204m = Chip$$ExternalSyntheticApiModelOutline0.m204m((Object) this.toolbar);
            titleMarginStart = toolbarM204m.getTitleMarginStart();
            titleMarginEnd = toolbarM204m.getTitleMarginEnd();
            titleMarginTop = toolbarM204m.getTitleMarginTop();
            titleMarginBottom = toolbarM204m.getTitleMarginBottom();
        }
    ...
    private static CharSequence getToolbarTitle(View view) {
        ...
        if (Build.VERSION.SDK_INT < 21 || !Chip$$ExternalSyntheticApiModelOutline0.m210m((Object) view)) {
            return null;
        }
        return Chip$$ExternalSyntheticApiModelOutline0.m204m((Object) view).getTitle();
    }
