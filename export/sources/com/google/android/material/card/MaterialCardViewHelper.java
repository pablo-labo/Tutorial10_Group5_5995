...
class MaterialCardViewHelper {
    ...
    public void animateCheckedIcon(boolean z) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.card.MaterialCardViewHelper$$ExternalSyntheticLambda1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                this.f$0.m190xa4d79c2b(valueAnimator2);
            }
        });
    ...
    /* synthetic */ void m190xa4d79c2b(ValueAnimator valueAnimator) {
    ...
    void recalculateCheckedIconPosition(int i, int i2) {
        ...
        if (this.clickableForegroundDrawable != null) {
            ...
            if ((Build.VERSION.SDK_INT < 21) || this.materialCardView.getUseCompatPadding()) {
                int iCeil2 = (int) Math.ceil(calculateVerticalBackgroundPadding() * 2.0f);
            ...
            if (isCheckedIconEnd()) {
                i4 = ((i - this.checkedIconMargin) - this.checkedIconSize) - iCeil;
            } else {
            ...
            if (isCheckedIconEnd()) {
                ...
                i6 = ((i - this.checkedIconMargin) - this.checkedIconSize) - iCeil;
            }
            if (isCheckedIconBottom()) {
    ...
    private void updateRippleColor() {
        ...
        if (RippleUtils.USE_FRAMEWORK_RIPPLE && (drawable = this.rippleDrawable) != null) {
            Chip$$ExternalSyntheticApiModelOutline0.m198m((Object) drawable).setColor(this.rippleColor);
            return;
        }
