...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    void setRippleColor(ColorStateList colorStateList) {
        if (ComponentDialog$$ExternalSyntheticApiModelOutline0.m24m((Object) this.rippleDrawable)) {
            Chip$$ExternalSyntheticApiModelOutline0.m198m((Object) this.rippleDrawable).setColor(RippleUtils.sanitizeRippleDrawableColor(colorStateList));
        } else {
