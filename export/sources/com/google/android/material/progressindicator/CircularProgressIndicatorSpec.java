...
public final class CircularProgressIndicatorSpec extends BaseProgressIndicatorSpec {
    ...
    int getIndicatorTrackGapSizeDegree() {
        ...
        double d = (this.indicatorSize - (this.indicatorInset * 2)) - this.trackThickness;
        Double.isNaN(d);
        double d2 = this.indicatorTrackGapSize + this.trackCornerRadius;
        Double.isNaN(d2);
        return (int) Math.round(360.0d / ((d * 3.141592653589793d) / d2));
    }
}
