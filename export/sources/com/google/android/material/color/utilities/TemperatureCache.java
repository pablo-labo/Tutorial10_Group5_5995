...
public final class TemperatureCache {
    ...
    public List<Hct> getAnalogousColors(int i, int i2) {
        ...
        while (true) {
            ...
            Double.isNaN(size);
            boolean z = dAbs >= size * d2;
            int i5 = 1;
            while (z && arrayList.size() < i2) {
                arrayList.add(hct2);
                double size2 = arrayList.size() + i5;
                Double.isNaN(size2);
                z = dAbs >= size2 * d2;
                i5++;
            }
        ...
        double d3 = i;
        Double.isNaN(d3);
        int iFloor = (int) Math.floor((d3 - 1.0d) / 2.0d);
        for (int i6 = 1; i6 < iFloor + 1; i6++) {
            ...
            arrayList2.add(0, (Hct) arrayList.get(size3));
        }
        int i7 = i - iFloor;
        for (int i8 = 1; i8 < i7; i8++) {
            ...
            arrayList2.add((Hct) arrayList.get(size4));
        }
        return arrayList2;
    }
    ...
    private List<Hct> getHctsByTemp() {
        ...
        Collections.sort(arrayList, Comparator.comparing(new Function() { // from class: com.google.android.material.color.utilities.TemperatureCache$$ExternalSyntheticLambda1
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return this.f$0.m251xb7a75f35((Hct) obj);
            }
        }, new Comparator() { // from class: com.google.android.material.color.utilities.TemperatureCache$$ExternalSyntheticLambda2
    ...
    /* synthetic */ Double m251xb7a75f35(Hct hct) {
