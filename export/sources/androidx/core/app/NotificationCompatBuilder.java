...
class NotificationCompatBuilder implements NotificationBuilderWithBuilderAccessor {
    ...
    NotificationCompatBuilder(NotificationCompat.Builder builder) {
        ...
        if (Build.VERSION.SDK_INT < 21 && (listCombineLists2 = combineLists(getPeople(builder.mPersonList), builder.mPeople)) != null && !listCombineLists2.isEmpty()) {
    ...
    protected Notification buildInternal() {
        ...
        if (Build.VERSION.SDK_INT >= 20) {
            ...
            if (this.mGroupAlertBehavior != 0) {
                if (Api20Impl.getGroup(notificationBuild3) != null && (notificationBuild3.flags & 512) != 0 && this.mGroupAlertBehavior == 2) {
                    removeSoundAndVibration(notificationBuild3);
                }
                if (Api20Impl.getGroup(notificationBuild3) != null && (notificationBuild3.flags & 512) == 0 && this.mGroupAlertBehavior == 1) {
                    removeSoundAndVibration(notificationBuild3);
                }
            }
