...
public final class NotificationManagerCompat {
    ...
    public void deleteUnlistedNotificationChannels(Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannel notificationChannelM5m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m5m((Object) it.next());
                if (!collection.contains(Api26Impl.getId(notificationChannelM5m)) && (Build.VERSION.SDK_INT < 30 || !collection.contains(Api30Impl.getParentChannelId(notificationChannelM5m)))) {
                    Api26Impl.deleteNotificationChannel(this.mNotificationManager, Api26Impl.getId(notificationChannelM5m));
                }
            }
        }
    }
    ...
    public NotificationChannelGroup getNotificationChannelGroup(String str) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannelGroup notificationChannelGroupM6m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m6m((Object) it.next());
                if (Api26Impl.getId(notificationChannelGroupM6m).equals(str)) {
                    return notificationChannelGroupM6m;
                }
            }
        }
        return null;
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannelGroups.isEmpty()) {
                ...
                while (it.hasNext()) {
                    NotificationChannelGroup notificationChannelGroupM6m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m6m((Object) it.next());
                    if (Build.VERSION.SDK_INT >= 28) {
                        arrayList.add(new NotificationChannelGroupCompat(notificationChannelGroupM6m));
                    } else {
                        arrayList.add(new NotificationChannelGroupCompat(notificationChannelGroupM6m, notificationChannels));
                    }
                }
                return arrayList;
            }
