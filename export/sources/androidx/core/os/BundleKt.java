...
public final class BundleKt {
    public static final Bundle bundleOf(Pair<String, ? extends Object>... pairArr) {
        ...
        for (Pair<String, ? extends Object> pair : pairArr) {
            ...
            } else if (Build.VERSION.SDK_INT >= 21 && BundleKt$$ExternalSyntheticApiModelOutline0.m117m(objComponent2)) {
                BundleApi21ImplKt.putSize(bundle, strComponent1, BundleKt$$ExternalSyntheticApiModelOutline0.m106m(objComponent2));
            } else if (Build.VERSION.SDK_INT >= 21 && BundleKt$$ExternalSyntheticApiModelOutline0.m$1(objComponent2)) {
                BundleApi21ImplKt.putSizeF(bundle, strComponent1, BundleKt$$ExternalSyntheticApiModelOutline0.m107m(objComponent2));
            } else {
