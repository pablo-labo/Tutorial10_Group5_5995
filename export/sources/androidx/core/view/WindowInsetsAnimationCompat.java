        ...
        private static class ProxyCallback extends WindowInsetsAnimation.Callback {
            ...
            public WindowInsets onProgress(WindowInsets windowInsets, List<WindowInsetsAnimation> list) {
                ...
                for (int size = list.size() - 1; size >= 0; size--) {
                    WindowInsetsAnimation windowInsetsAnimationM131m = WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m131m((Object) list.get(size));
                    WindowInsetsAnimationCompat windowInsetsAnimationCompat = getWindowInsetsAnimationCompat(windowInsetsAnimationM131m);
                    windowInsetsAnimationCompat.setFraction(windowInsetsAnimationM131m.getFraction());
