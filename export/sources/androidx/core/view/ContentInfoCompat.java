...
public final class ContentInfoCompat {
    ...
    public ContentInfo toContentInfo() {
        return BundleKt$$ExternalSyntheticApiModelOutline0.m108m(Objects.requireNonNull(this.mCompat.getWrapped()));
    }
    ...
    private static final class Compat31Impl implements Compat {
        ...
        Compat31Impl(ContentInfo contentInfo) {
            this.mWrapped = BundleKt$$ExternalSyntheticApiModelOutline0.m108m(Preconditions.checkNotNull(contentInfo));
        }
