...
public class ViewCompat {
    ...
    private static final OnReceiveContentViewBehavior NO_OP_ON_RECEIVE_CONTENT_VIEW_BEHAVIOR = new OnReceiveContentViewBehavior() { // from class: androidx.core.view.ViewCompat$$ExternalSyntheticLambda2
    ...
    public static void setPointerIcon(View view, PointerIconCompat pointerIconCompat) {
        if (Build.VERSION.SDK_INT >= 24) {
            Api24Impl.setPointerIcon(view, BundleKt$$ExternalSyntheticApiModelOutline0.m109m(pointerIconCompat != null ? pointerIconCompat.getPointerIcon() : null));
        }
    }
