    ...
    private static class BuilderImpl20 extends BuilderImpl {
        ...
        private static WindowInsets createWindowInsetsInstance() {
            if (!sConsumedFieldFetched) {
                try {
                    sConsumedField = WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m137m().getDeclaredField("CONSUMED");
                } catch (ReflectiveOperationException e) {
            ...
            if (field != null) {
                try {
                    WindowInsets windowInsetsM = WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m(field.get(null));
                    if (windowInsetsM != null) {
                        return new WindowInsets(windowInsetsM);
                    }
            ...
            if (!sConstructorFetched) {
                try {
                    sConstructor = WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m137m().getConstructor(Rect.class);
            ...
            if (constructor != null) {
                try {
                    return WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m((Object) constructor.newInstance(new Rect()));
