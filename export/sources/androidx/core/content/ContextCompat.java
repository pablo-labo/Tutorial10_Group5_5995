    ...
    private static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            if (Build.VERSION.SDK_INT >= 22) {
                ...
                map.put(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$3(), "usagestats");
            }
            if (Build.VERSION.SDK_INT >= 21) {
                map.put(AppWidgetManager.class, "appwidget");
                map.put(BatteryManager.class, "batterymanager");
                map.put(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$4(), "camera");
                map.put(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$5(), "jobscheduler");
                map.put(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$6(), "launcherapps");
                map.put(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$7(), "media_projection");
                map.put(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$8(), "media_session");
                map.put(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$9(), "restrictions");
                map.put(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$10(), "telecom");
                map.put(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$11(), "tv_input");
            }
