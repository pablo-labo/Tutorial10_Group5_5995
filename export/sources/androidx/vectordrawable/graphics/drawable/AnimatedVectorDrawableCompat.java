...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    public boolean isRunning() {
        if (this.mDelegateDrawable != null) {
            return Trace$$ExternalSyntheticApiModelOutline0.m((Object) this.mDelegateDrawable).isRunning();
        }
    ...
    public void start() {
        if (this.mDelegateDrawable != null) {
            Trace$$ExternalSyntheticApiModelOutline0.m((Object) this.mDelegateDrawable).start();
        } else {
            if (this.mAnimatedVectorState.mAnimatorSet.isStarted()) {
                return;
            }
    ...
    public void stop() {
        if (this.mDelegateDrawable != null) {
            Trace$$ExternalSyntheticApiModelOutline0.m((Object) this.mDelegateDrawable).stop();
        } else {
    ...
    public void registerAnimationCallback(Animatable2Compat.AnimationCallback animationCallback) {
        if (this.mDelegateDrawable != null) {
            registerPlatformCallback(Trace$$ExternalSyntheticApiModelOutline0.m((Object) this.mDelegateDrawable), animationCallback);
            return;
        }
    ...
    public boolean unregisterAnimationCallback(Animatable2Compat.AnimationCallback animationCallback) {
        if (this.mDelegateDrawable != null) {
            unregisterPlatformCallback(Trace$$ExternalSyntheticApiModelOutline0.m((Object) this.mDelegateDrawable), animationCallback);
        }
    ...
    public void clearAnimationCallbacks() {
        if (this.mDelegateDrawable != null) {
            Trace$$ExternalSyntheticApiModelOutline0.m((Object) this.mDelegateDrawable).clearAnimationCallbacks();
            return;
        }
        removeAnimatorSetListener();
        ArrayList<Animatable2Compat.AnimationCallback> arrayList = this.mAnimationCallbacks;
    ...
    public static void registerAnimationCallback(Drawable drawable, Animatable2Compat.AnimationCallback animationCallback) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            registerPlatformCallback(Trace$$ExternalSyntheticApiModelOutline0.m((Object) drawable), animationCallback);
        } else {
    ...
    public static boolean unregisterAnimationCallback(Drawable drawable, Animatable2Compat.AnimationCallback animationCallback) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            return unregisterPlatformCallback(Trace$$ExternalSyntheticApiModelOutline0.m((Object) drawable), animationCallback);
        }
    ...
    public static void clearAnimationCallbacks(Drawable drawable) {
        if (drawable instanceof Animatable) {
            if (Build.VERSION.SDK_INT >= 24) {
                Trace$$ExternalSyntheticApiModelOutline0.m((Object) drawable).clearAnimationCallbacks();
            } else {
