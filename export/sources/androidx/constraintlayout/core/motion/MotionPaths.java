...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    void getCenter(double d, int[] iArr, double[] dArr, float[] fArr, double[] dArr2, float[] fArr2) {
        ...
        if (motion != null) {
            ...
            Double.isNaN(d13);
            f14 = (float) ((d14 - (d11 * dCos3)) + (dSin3 * d13));
            f13 = f20;
            f2 = f19;
            f3 = (float) (d8 - d9);
            f12 = 2.0f;
    ...
    void setView(float f, MotionWidget motionWidget, int[] iArr, double[] dArr, double[] dArr2, double[] dArr3) {
        ...
        if (motion != null) {
            ...
            double d12 = f10;
            Double.isNaN(d12);
            float f22 = (float) (d11 + (dCos2 * d3 * d12));
            double d13 = f19;
            double dCos3 = Math.cos(d4);
            Double.isNaN(d10);
            Double.isNaN(d13);
            ...
            Double.isNaN(d3);
            Double.isNaN(d12);
            float f23 = (float) ((d13 - (d10 * dCos3)) + (d3 * dSin3 * d12));
            if (dArr2.length >= 2) {
                dArr2[0] = f22;
                dArr2[1] = f23;
            }
            if (!Float.isNaN(f15)) {
                ...
                Double.isNaN(d14);
                motionWidget.setRotationZ((float) (d14 + degrees));
            }
            f4 = f20;
            f5 = f21;
        } else {
            ...
            if (!Float.isNaN(f15)) {
                ...
                Double.isNaN(d16);
                Double.isNaN(d15);
                motionWidget.setRotationZ((float) (d15 + d16 + degrees2));
            }
        }
        float f24 = f4 + 0.5f;
        float f25 = f5 + 0.5f;
