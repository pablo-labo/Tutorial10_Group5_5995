    ...
    private float getPreCycleDistance() {
        ...
        while (i < 100) {
            ...
            if (i2 > 0) {
                ...
                double d6 = fArr[0];
                Double.isNaN(d6);
                double dHypot = Math.hypot(d2 - d5, d - d6);
                Double.isNaN(d4);
                f2 = (float) (d4 + dHypot);
            } else {
                f2 = f6;
        ...
        while (true) {
            ...
            while (i14 < i) {
                if (motionPathsArr[i14].hasCustomData(str10)) {
                    if (dArr5 == null) {
                        dArr4 = new double[i];
                        dArr5 = (double[][]) Array.newInstance((Class<?>) Double.TYPE, i, motionPathsArr[i14].getCustomDataCount(str10));
                    }
                    dArr = dArr2;
                    dArr4[i15] = motionPathsArr[i14].time;
                    motionPathsArr[i14].getCustomData(str10, dArr5[i15], 0);
                    i15++;
                } else {
                    dArr = dArr2;
                }
