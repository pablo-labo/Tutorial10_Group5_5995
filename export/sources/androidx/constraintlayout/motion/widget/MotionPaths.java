...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    void getCenter(double p, int[] toUse, double[] data, float[] point, double[] vdata, float[] velocity) {
        ...
        if (motionController != null) {
            ...
            Double.isNaN(d12);
            f14 = (float) ((d13 - (d10 * dCos3)) + (dSin3 * d12));
            f13 = f20;
            f2 = f19;
            f3 = (float) (d7 - d8);
            f12 = 2.0f;
    ...
    void setView(float position, View view, int[] toUse, double[] data, double[] slope, double[] cycle, boolean mForceMeasure) {
        ...
        if (motionController != null) {
            ...
            double d5 = f5 / 2.0f;
            Double.isNaN(d5);
            float f19 = (float) ((d2 + (dSin * d3)) - d5);
            double d6 = f16;
            double dCos = Math.cos(d4);
            Double.isNaN(d3);
            Double.isNaN(d6);
            double d7 = d6 - (dCos * d3);
            f = f6;
            double d8 = f6 / 2.0f;
            Double.isNaN(d8);
            float f20 = (float) (d7 - d8);
            double d9 = f17;
            double d10 = f8;
            ...
            double d12 = f9;
            Double.isNaN(d12);
            float f21 = (float) (d11 + (dCos2 * d3 * d12));
            double d13 = f18;
            ...
            Double.isNaN(d3);
            Double.isNaN(d12);
            float f22 = (float) ((d13 - (d10 * dCos3)) + (d3 * dSin3 * d12));
            if (slope.length >= 2) {
                slope[0] = f21;
                slope[1] = f22;
            }
            if (!Float.isNaN(f14)) {
                double d14 = f14;
                double degrees = Math.toDegrees(Math.atan2(f22, f21));
                Double.isNaN(d14);
            ...
            if (!Float.isNaN(f14)) {
                double d15 = 0.0f;
                double d16 = f14;
                double degrees2 = Math.toDegrees(Math.atan2(f9 + (f11 / 2.0f), f8 + (f10 / 2.0f)));
                Double.isNaN(d16);
                Double.isNaN(d15);
