...
public final class CompletionStateKt {
        ...
        if (thM302exceptionOrNullimpl != null) {
            if (DebugKt.getRECOVER_STACK_TRACES()) {
                ...
                if (cancellableContinuation2 instanceof CoroutineStackFrame) {
                    thM302exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(thM302exceptionOrNullimpl, (CoroutineStackFrame) cancellableContinuation2);
                }
            }
            obj = new CompletedExceptionally(thM302exceptionOrNullimpl, false, 2, null);
        }
        return obj;
    }
    ...
    public static final <T> Object recoverResult(Object obj, Continuation<? super T> continuation) {
        if (obj instanceof CompletedExceptionally) {
            ...
            return Result.m299constructorimpl(ResultKt.createFailure(thRecoverFromStackFrame));
        }
