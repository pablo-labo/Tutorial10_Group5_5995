...
public final class AbstractChannelKt {
    ...
    private static final <E> Object toResult(Object obj) {
        return obj instanceof Closed ? ChannelResult.INSTANCE.m1867closedJP2dKIU(((Closed) obj).closeCause) : ChannelResult.INSTANCE.m1869successJP2dKIU(obj);
    }

    private static final <E> Object toResult(Closed<?> closed) {
        return ChannelResult.INSTANCE.m1867closedJP2dKIU(closed.closeCause);
    }
}
