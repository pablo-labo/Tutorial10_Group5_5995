...
public interface SendChannel<E> {
    ...
    Object mo1849trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m1864isSuccessimpl(objMo1849trySendJP2dKIU)) {
                return true;
            }
            Throwable thM1858exceptionOrNullimpl = ChannelResult.m1858exceptionOrNullimpl(objMo1849trySendJP2dKIU);
