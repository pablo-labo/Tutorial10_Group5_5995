...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            try {
                ...
                objM299constructorimpl = Result.m299constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM299constructorimpl = Result.m299constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m1854boximpl(Result.m306isSuccessimpl(objM299constructorimpl) ? ChannelResult.INSTANCE.m1869successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1867closedJP2dKIU(Result.m302exceptionOrNullimpl(objM299constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo1849trySendJP2dKIU = sendChannel.mo1849trySendJP2dKIU(e);
        if (objMo1849trySendJP2dKIU instanceof ChannelResult.Failed) {
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) throws InterruptedException {
        if (ChannelResult.m1864isSuccessimpl(sendChannel.mo1849trySendJP2dKIU(e))) {
            return;
        }
