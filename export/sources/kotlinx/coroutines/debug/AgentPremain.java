...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM299constructorimpl = Result.m299constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM299constructorimpl = Result.m299constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m305isFailureimpl(objM299constructorimpl) ? null : objM299constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1872installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1872installSignalHandler$lambda1(Signal signal) {
