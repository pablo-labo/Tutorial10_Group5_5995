...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM299constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM299constructorimpl = Result.m299constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM299constructorimpl = Result.m299constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m302exceptionOrNullimpl(objM299constructorimpl) == null) {
            obj2 = objM299constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM299constructorimpl2 = Result.m299constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM299constructorimpl2 = Result.m299constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m302exceptionOrNullimpl(objM299constructorimpl2) == null) {
            obj = objM299constructorimpl2;
        }
