...
public final class UStringsKt {
    ...
    public static final String m1656toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1658toStringolVBNx4(short s, int i) {
    ...
    public static final String m1657toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1655toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m395constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m311boximpl(UByte.m317constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m395constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m575boximpl(UShort.m581constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM395constructorimpl = UInt.m395constructorimpl(i);
        int iM = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                if (iM == 119304647) {
                    iM = UByte$$ExternalSyntheticBackport0.m(-1, iM395constructorimpl);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM395constructorimpl2 = UInt.m395constructorimpl(i3 * iM395constructorimpl);
            int iM395constructorimpl3 = UInt.m395constructorimpl(UInt.m395constructorimpl(iDigitOf) + iM395constructorimpl2);
            if (Integer.compare(iM395constructorimpl3 ^ Integer.MIN_VALUE, iM395constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM395constructorimpl3;
        }
        return UInt.m389boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM474constructorimpl = ULong.m474constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM474constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM474constructorimpl2 = ULong.m474constructorimpl(j * jM474constructorimpl);
            long jM474constructorimpl3 = ULong.m474constructorimpl(ULong.m474constructorimpl(((long) UInt.m395constructorimpl(iDigitOf)) & 4294967295L) + jM474constructorimpl2);
            if (Long.compare(jM474constructorimpl3 ^ Long.MIN_VALUE, jM474constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM474constructorimpl3;
        }
        return ULong.m468boximpl(j);
    }
}
