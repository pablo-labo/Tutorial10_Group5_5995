...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1519getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM474constructorimpl = ((int) ULong.m474constructorimpl(j ^ ULong.m474constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM474constructorimpl2 = (iM474constructorimpl + ((int) ULong.m474constructorimpl(j2 ^ ULong.m474constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + iM474constructorimpl2;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m520toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m520toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
