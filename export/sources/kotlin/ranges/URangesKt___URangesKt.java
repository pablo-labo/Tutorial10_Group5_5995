...
public class URangesKt___URangesKt {
    ...
    public static final UInt firstOrNull(UIntProgression uIntProgression) {
        ...
        return UInt.m389boximpl(uIntProgression.getFirst());
    }
    ...
    public static final ULong firstOrNull(ULongProgression uLongProgression) {
        ...
        return ULong.m468boximpl(uLongProgression.getFirst());
    }
    ...
    public static final UInt lastOrNull(UIntProgression uIntProgression) {
        ...
        return UInt.m389boximpl(uIntProgression.getLast());
    }
    ...
    public static final ULong lastOrNull(ULongProgression uLongProgression) {
        ...
        return ULong.m468boximpl(uLongProgression.getLast());
    }
    ...
    public static final UInt randomOrNull(UIntRange uIntRange, Random random) {
        ...
        return UInt.m389boximpl(URandomKt.nextUInt(random, uIntRange));
    }
    ...
    public static final ULong randomOrNull(ULongRange uLongRange, Random random) {
        ...
        return ULong.m468boximpl(URandomKt.nextULong(random, uLongRange));
    }
    ...
    public static final boolean m1600contains68kG9v0(UIntRange contains, byte b) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1573containsWZ4Q5Ns(UInt.m395constructorimpl(b & UByte.MAX_VALUE));
    }
    ...
    public static final boolean m1603containsULbyJY(ULongRange contains, byte b) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1582containsVKZWuLQ(ULong.m474constructorimpl(((long) b) & 255));
    }
    ...
    public static final boolean m1602containsGab390E(ULongRange contains, int i) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1582containsVKZWuLQ(ULong.m474constructorimpl(((long) i) & 4294967295L));
    }
    ...
    public static final boolean m1606containsfz5IDCE(UIntRange contains, long j) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return ULong.m474constructorimpl(j >>> 32) == 0 && contains.m1573containsWZ4Q5Ns(UInt.m395constructorimpl((int) j));
    }
    ...
    public static final boolean m1604containsZsK3CEQ(UIntRange contains, short s) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1573containsWZ4Q5Ns(UInt.m395constructorimpl(s & UShort.MAX_VALUE));
    }
    ...
    public static final boolean m1607containsuhHAxoY(ULongRange contains, short s) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1582containsVKZWuLQ(ULong.m474constructorimpl(((long) s) & 65535));
    }
    ...
    public static final UIntProgression m1610downToKr8caGY(byte b, byte b2) {
        return UIntProgression.INSTANCE.m1570fromClosedRangeNkh28Cs(UInt.m395constructorimpl(b & UByte.MAX_VALUE), UInt.m395constructorimpl(b2 & UByte.MAX_VALUE), -1);
    }
    ...
    public static final UIntProgression m1608downTo5PvTz6A(short s, short s2) {
        return UIntProgression.INSTANCE.m1570fromClosedRangeNkh28Cs(UInt.m395constructorimpl(s & UShort.MAX_VALUE), UInt.m395constructorimpl(s2 & UShort.MAX_VALUE), -1);
    }
    ...
    public static final UIntRange m1614untilKr8caGY(byte b, byte b2) {
        return Intrinsics.compare(b2 & UByte.MAX_VALUE, 0) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange(UInt.m395constructorimpl(b & UByte.MAX_VALUE), UInt.m395constructorimpl(UInt.m395constructorimpl(r3) - 1), null);
    }
    ...
    public static final UIntRange m1613untilJ1ME1BU(int i, int i2) {
        return Integer.compare(i2 ^ Integer.MIN_VALUE, 0 ^ Integer.MIN_VALUE) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange(i, UInt.m395constructorimpl(i2 - 1), null);
    }
    ...
    public static final ULongRange m1615untileb3DHEI(long j, long j2) {
        return Long.compare(j2 ^ Long.MIN_VALUE, 0 ^ Long.MIN_VALUE) <= 0 ? ULongRange.INSTANCE.getEMPTY() : new ULongRange(j, ULong.m474constructorimpl(j2 - ULong.m474constructorimpl(((long) 1) & 4294967295L)), null);
    }
    ...
    public static final UIntRange m1612until5PvTz6A(short s, short s2) {
        return Intrinsics.compare(s2 & UShort.MAX_VALUE, 0) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange(UInt.m395constructorimpl(s & UShort.MAX_VALUE), UInt.m395constructorimpl(UInt.m395constructorimpl(r3) - 1), null);
    }
    ...
    public static final int m1596coerceInWZ9TVnA(int i, int i2, int i3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) UInt.m441toStringimpl(i3)) + " is less than minimum " + ((Object) UInt.m441toStringimpl(i2)) + '.');
    }
    ...
    public static final long m1598coerceInsambcqE(long j, long j2, long j3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) ULong.m520toStringimpl(j3)) + " is less than minimum " + ((Object) ULong.m520toStringimpl(j2)) + '.');
    }
    ...
    public static final byte m1597coerceInb33U2AM(byte b, byte b2, byte b3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) UByte.m361toStringimpl(b3)) + " is less than minimum " + ((Object) UByte.m361toStringimpl(b2)) + '.');
    }
    ...
    public static final short m1595coerceInVKSA0NQ(short s, short s2, short s3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) UShort.m625toStringimpl(s3)) + " is less than minimum " + ((Object) UShort.m625toStringimpl(s2)) + '.');
    }
    ...
    public static final int m1599coerceInwuiCnnA(int i, ClosedRange<UInt> range) {
        ...
        if (range instanceof ClosedFloatingPointRange) {
            return ((UInt) RangesKt.coerceIn(UInt.m389boximpl(i), (ClosedFloatingPointRange<UInt>) range)).getData();
        }
        if (!range.isEmpty()) {
    ...
    public static final long m1594coerceInJPwROB0(long j, ClosedRange<ULong> range) {
        Intrinsics.checkNotNullParameter(range, "range");
        if (range instanceof ClosedFloatingPointRange) {
            return ((ULong) RangesKt.coerceIn(ULong.m468boximpl(j), (ClosedFloatingPointRange<ULong>) range)).getData();
        }
        if (!range.isEmpty()) {
