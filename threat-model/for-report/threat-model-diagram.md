...
Unified horizontal style with color-coded classes and compact labels for single-column layout.
...
## Figure Notes
- Threat logic: `Vulnerability -> Goal -> Impact`, conditioned by capabilities and preconditions.
- Claim boundaries are explicit through constraints L1-L3.
- Evidence anchors tie the model to code locations.
