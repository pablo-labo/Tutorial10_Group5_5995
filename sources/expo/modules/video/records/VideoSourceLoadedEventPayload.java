...
public final class VideoSourceLoadedEventPayload implements VideoEventPayload {
    ...
    public VideoSourceLoadedEventPayload(VideoSource videoSource, double d, List<VideoTrack> list, List<SubtitleTrack> list2, List<AudioTrack> list3) {
        list.getClass();
        list2.getClass();
        list3.getClass();
        this.videoSource = videoSource;
        this.duration = d;
        this.availableVideoTracks = list;
        this.availableSubtitleTracks = list2;
