...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\u00020\u0001:\u0001\u0002¨\u0006\u0003"}, d2 = {"Lokhttp3/internal/tls/BasicCertificateChainCleaner;", "Lokhttp3/internal/tls/CertificateChainCleaner;", "Companion", "okhttp"}, k = 1, mv = {1, 8, 0}, xi = 48)
public final class BasicCertificateChainCleaner extends CertificateChainCleaner {
        ...
        for (int i = 0; i < 9; i++) {
            ...
            if (x509CertificateA == null) {
                ...
                while (it.hasNext()) {
                    ...
                    if (wl7.b(x509Certificate.getIssuerDN(), x509Certificate2.getSubjectDN())) {
                        try {
            ...
            if (wl7.b(x509CertificateA.getIssuerDN(), x509CertificateA.getSubjectDN())) {
                try {
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof BasicCertificateChainCleaner) && wl7.b(((BasicCertificateChainCleaner) obj).b, this.b);
    }
