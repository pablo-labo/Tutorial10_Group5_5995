...
public class EllipticCurveSignatureValidator extends EllipticCurveProvider implements SignatureValidator {
    ...
    public boolean isValid(byte[] bArr, byte[] bArr2) {
        ...
        try {
            ...
            throw new io.jsonwebtoken.security.SignatureException(b0.h(e, new StringBuilder("Unable to verify Elliptic Curve signature using configured ECPublicKey. ")), e);
        }
    }
}
