...
public final class Keys {
    ...
    /* JADX INFO: renamed from: io.jsonwebtoken.security.Keys$1, reason: invalid class name */
    ...
    public static KeyPair keyPairFor(SignatureAlgorithm signatureAlgorithm) {
        ...
        switch (AnonymousClass1.$SwitchMap$io$jsonwebtoken$SignatureAlgorithm[signatureAlgorithm.ordinal()]) {
            ...
            default:
                bg.l("The ", signatureAlgorithm.name(), " algorithm does not support Key Pairs.");
                return null;
        }
    }
    ...
    public static SecretKey secretKeyFor(SignatureAlgorithm signatureAlgorithm) {
        ...
        bg.l("The ", signatureAlgorithm.name(), " algorithm does not support shared secret keys.");
        return null;
    }
}
