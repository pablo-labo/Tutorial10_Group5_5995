...
public class CameraEnumerationAndroid {
    static final ArrayList<Size> COMMON_RESOLUTIONS = new ArrayList<>(Arrays.asList(new Size(160, 120), new Size(240, 160), new Size(320, 240), new Size(DataOkHttpUploader.HTTP_BAD_REQUEST, 240), new Size(480, 320), new Size(640, 360), new Size(640, 480), new Size(768, 480), new Size(854, 480), new Size(DefaultAndroidInfoProvider.MIN_TABLET_WIDTH_DP, 600), new Size(960, 540), new Size(960, 640), new Size(IntBufferBatchMountItem.INSTRUCTION_UPDATE_OVERFLOW_INSET, 576), new Size(IntBufferBatchMountItem.INSTRUCTION_UPDATE_OVERFLOW_INSET, 600), new Size(1280, 720), new Size(1280, IntBufferBatchMountItem.INSTRUCTION_UPDATE_OVERFLOW_INSET), new Size(1920, 1080), new Size(1920, 1440), new Size(2560, 1440), new Size(3840, 2160)));
    ...
    public static CaptureFormat.FramerateRange getClosestSupportedFramerateRange(List<CaptureFormat.FramerateRange> list, final int i) {
        return (CaptureFormat.FramerateRange) Collections.min(list, new ClosestComparator<CaptureFormat.FramerateRange>() { // from class: org.webrtc.CameraEnumerationAndroid.1
            ...
            private int progressivePenalty(int i2, int i3, int i4, int i5) {
                return i2 < i3 ? i2 * i4 : l5.c(i2, i3, i5, i4 * i3);
            }
    ...
    public static class CaptureFormat {
        ...
        public static int frameSize(int i, int i2, int i3) {
            ...
            b0.u("Don't know how to calculate the frame size of non-NV21 image formats.");
            return 0;
        }
