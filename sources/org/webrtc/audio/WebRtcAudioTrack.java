...
class WebRtcAudioTrack {
            ...
            while (this.keepAlive) {
                ...
                if (iWrite != iCapacity) {
                    ...
                    if (iWrite < 0) {
                        ...
                        WebRtcAudioTrack.this.reportWebRtcAudioTrackError(p6.c(iWrite, "AudioTrack.write failed: "));
                    }
                }
    ...
    private void logMainParameters() {
        ...
        StringBuilder sbF = uz.f("AudioTrack: session ID: ", audioSessionId, ", channels: ", channelCount, ", sample rate: ");
        sbF.append(sampleRate);
        sbF.append(", max gain: ");
        sbF.append(maxVolume);
    ...
    private boolean startPlayout() {
        ...
        try {
            ...
            if (this.audioTrack.getPlayState() != 3) {
                reportWebRtcAudioTrackStartError(JavaAudioDeviceModule.AudioTrackStartErrorCode.AUDIO_TRACK_START_STATE_MISMATCH, p6.c(this.audioTrack.getPlayState(), "AudioTrack.play failed - incorrect state :"));
                releaseAudioResources();
                return false;
            }
            ...
            reportWebRtcAudioTrackStartError(JavaAudioDeviceModule.AudioTrackStartErrorCode.AUDIO_TRACK_START_EXCEPTION, l5.l("AudioTrack.play failed: ", e.getMessage()));
            releaseAudioResources();
            return false;
        }
    }
