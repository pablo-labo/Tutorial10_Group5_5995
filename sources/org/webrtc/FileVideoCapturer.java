    ...
    public static class VideoReaderY4M implements VideoReader {
        ...
        public VideoReaderY4M(String str) throws IOException {
            ...
            while (true) {
                ...
                if (i == -1) {
                    b0.o(l5.l("Found end of file before end of header for file: ", str));
                    throw null;
                }
                if (i == 10) {
                    ...
                    if (!strSubstring.equals("420") && !strSubstring.equals("420mpeg2")) {
                        l5.q("Does not support any other color space than I420 or I420mpeg2");
                        throw null;
                    }
                    if (i2 % 2 == 1 || i3 % 2 == 1) {
                        l5.q("Does not support odd width or height");
                        throw null;
                    }
                    this.frameWidth = i2;
                    this.frameHeight = i3;
                    Logging.d(TAG, w40.e("frame dim: (", i2, ", ", i3, ")"));
                    return;
                }
                sb.append((char) i);
            }
