...
public class SurfaceTextureHelper {
    ...
    private SurfaceTextureHelper(EglBase.Context context, Handler handler, boolean z, YuvConverter yuvConverter, FrameRefMonitor frameRefMonitor) {
        ...
        if (handler.getLooper().getThread() != Thread.currentThread()) {
            r6.g("SurfaceTextureHelper must be created on the handler thread");
            throw null;
        }
        ...
        try {
            ...
            surfaceTexture.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: r0f
    ...
    public void returnTextureFrame() {
        this.handler.post(new xn0(this, 8));
    }
    ...
    public void dispose() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new jy1(this, 4));
    }

    public void forceFrame() {
        this.handler.post(new my1(this, 11));
    }
    ...
    public void setFrameRotation(int i) {
        this.handler.post(new s0f(this, i, 0));
    }

    public void setTextureSize(final int i, final int i2) {
        if (i <= 0) {
            l5.q(p6.c(i, "Texture width must be positive, but was "));
        } else if (i2 <= 0) {
            l5.q(p6.c(i2, "Texture height must be positive, but was "));
        } else {
            this.surfaceTexture.setDefaultBufferSize(i, i2);
            this.handler.post(new Runnable() { // from class: q0f
                @Override // java.lang.Runnable
                public final void run() {
                    this.a.lambda$setTextureSize$2(i, i2);
                }
            });
        }
    }
    ...
    public void startListening(VideoSink videoSink) {
        if (this.listener != null || this.pendingListener != null) {
            r6.g("SurfaceTextureHelper listener has already been set.");
        } else {
    ...
    public void stopListening() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new hy1(this, 4));
    }
