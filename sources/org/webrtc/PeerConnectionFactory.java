...
public class PeerConnectionFactory {
    ...
    public PeerConnectionFactory(long j) {
        ...
        if (j != 0) {
            ...
            b0.o("Failed to initialize PeerConnectionFactory!");
            throw null;
        }
    }
    ...
    public static void checkInitializeHasBeenCalled() {
        if (!NativeLibrary.isLoaded() || ContextUtils.getApplicationContext() == null) {
            r6.g("PeerConnectionFactory.initialize was not called before creating a PeerConnectionFactory.");
        }
    }
    ...
    private void checkPeerConnectionFactoryExists() {
        ...
        r6.g("PeerConnectionFactory has been disposed.");
    }
    ...
    private static void printStackTrace(ThreadInfo threadInfo, boolean z) {
        ...
        if (z) {
            Logging.w(TAG, "*** *** *** *** *** *** *** *** *** *** *** *** *** *** *** ***");
            StringBuilder sbF = uz.f("pid: ", Process.myPid(), ", tid: ", threadInfo.tid, ", name: ");
            sbF.append(name);
            sbF.append("  >>> WebRTC <<<");
            Logging.w(TAG, sbF.toString());
    ...
    public static class Builder {
        ...
        public Builder setAudioDecoderFactoryFactory(AudioDecoderFactoryFactory audioDecoderFactoryFactory) {
            ...
            l5.q("PeerConnectionFactory.Builder does not accept a null AudioDecoderFactoryFactory.");
            return null;
        }
        ...
        public Builder setAudioEncoderFactoryFactory(AudioEncoderFactoryFactory audioEncoderFactoryFactory) {
            ...
            l5.q("PeerConnectionFactory.Builder does not accept a null AudioEncoderFactoryFactory.");
            return null;
        }
        ...
        public Builder setAudioProcessingFactory(AudioProcessingFactory audioProcessingFactory) {
            ...
            ja.k("PeerConnectionFactory builder does not accept a null AudioProcessingFactory.");
            return null;
        }
