...
class Camera2Session implements CameraSession {
    ...
    private void openCamera() {
        ...
        try {
            ...
            reportError(bg.e(e, "Failed to open camera: "));
        }
    }
    ...
    private void start() {
        ...
        try {
            ...
            reportError(l5.l("getCameraCharacteristics(): ", e.getMessage()));
        }
    }
    ...
    public class CameraStateCallback extends CameraDevice.StateCallback {
        ...
        private String getErrorDescription(int i) {
            return i != 1 ? i != 2 ? i != 3 ? i != 4 ? i != 5 ? p6.c(i, "Unknown camera error: ") : "Camera service has encountered a fatal error." : "Camera device has encountered a fatal error." : "Camera device could not be opened due to a device policy." : "Camera device could not be opened because there are too many other open camera devices." : "Camera device is in use already.";
        }
