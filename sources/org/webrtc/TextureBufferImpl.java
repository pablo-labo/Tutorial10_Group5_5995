...
public class TextureBufferImpl implements VideoFrame.TextureBuffer {
    ...
    private TextureBufferImpl(int i, int i2, int i3, int i4, VideoFrame.TextureBuffer.Type type, int i5, Matrix matrix, Handler handler, YuvConverter yuvConverter, final RefCountMonitor refCountMonitor) {
        ...
        this.refCountDelegate = new RefCountDelegate(new Runnable() { // from class: org.webrtc.g
            @Override // java.lang.Runnable
            public final void run() {
                this.a.lambda$new$0(refCountMonitor);
            }
        });
    ...
    public VideoFrame.I420Buffer toI420() {
        return (VideoFrame.I420Buffer) ThreadUtils.invokeAtFrontUninterruptibly(this.toI420Handler, new Callable() { // from class: ikf
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.a.lambda$toI420$1();
            }
        });
    }
