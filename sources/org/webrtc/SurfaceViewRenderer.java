...
public class SurfaceViewRenderer extends SurfaceView implements SurfaceHolder.Callback, VideoSink, RendererCommon.RendererEvents {
    ...
    private void updateSurfaceSize() {
        ...
        StringBuilder sbF = uz.f("updateSurfaceSize. Layout size: ", width2, "x", height, ", frame size: ");
        uz.i(sbF, i3, "x", i4, ", requested surface size: ");
        uz.i(sbF, iMin, "x", iMin2, ", old surface size: ");
        sbF.append(i5);
        sbF.append("x");
        sbF.append(i6);
        logD(sbF.toString());
    ...
    public void onFrameResolutionChanged(final int i, int i2, int i3) {
        ...
        postOrRun(new Runnable() { // from class: t0f
            @Override // java.lang.Runnable
            public final void run() {
                this.a.lambda$onFrameResolutionChanged$0(i4, i);
            }
        });
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        logD(k20.l("onMeasure(). New size: ", pointMeasure.x, pointMeasure.y, "x"));
    }
