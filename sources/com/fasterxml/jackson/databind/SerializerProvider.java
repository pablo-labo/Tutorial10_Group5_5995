...
public abstract class SerializerProvider extends DatabindContext {
    ...
    public JsonSerializer<Object> _findExplicitUntypedSerializer(Class<?> cls) throws InvalidDefinitionException {
    ...
    public JsonMappingException invalidTypeIdException(JavaType javaType, String str, String str2) {
        return InvalidTypeIdException.from(null, _colonConcat(t40.l("Could not resolve type id '", str, "' as a subtype of ", ClassUtil.getTypeDescription(javaType)), str2), javaType, str);
    }
    ...
    public <T> T reportBadPropertyDefinition(BeanDescription beanDescription, BeanPropertyDefinition beanPropertyDefinition, String str, Object... objArr) throws InvalidDefinitionException {
        ...
        StringBuilder sbF = u40.f("Invalid definition for property ", beanPropertyDefinition != null ? _quotedString(beanPropertyDefinition.getName()) : "N/A", " (of type ", beanDescription != null ? ClassUtil.nameOf(beanDescription.getBeanClass()) : "N/A", "): ");
        sbF.append(str_format);
        throw InvalidDefinitionException.from(getGenerator(), sbF.toString(), beanDescription, beanPropertyDefinition);
    }
    ...
    public <T> T reportBadTypeDefinition(BeanDescription beanDescription, String str, Object... objArr) throws InvalidDefinitionException {
        throw InvalidDefinitionException.from(getGenerator(), t40.l("Invalid type definition for type ", beanDescription != null ? ClassUtil.nameOf(beanDescription.getBeanClass()) : "N/A", ": ", _format(str, objArr)), beanDescription, (BeanPropertyDefinition) null);
    }
