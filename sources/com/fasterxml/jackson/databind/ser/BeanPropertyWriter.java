...
public class BeanPropertyWriter extends PropertyWriter implements Serializable {
    ...
    public void assignNullSerializer(JsonSerializer<Object> jsonSerializer) {
        ...
        if (jsonSerializer2 == null || jsonSerializer2 == jsonSerializer) {
            ...
            r6.g(t40.l("Cannot override _nullSerializer: had a ", ClassUtil.classNameOf(jsonSerializer2), ", trying to set to ", ClassUtil.classNameOf(jsonSerializer)));
        }
    }
    ...
    public void assignSerializer(JsonSerializer<Object> jsonSerializer) {
        ...
        if (jsonSerializer2 == null || jsonSerializer2 == jsonSerializer) {
            ...
            r6.g(t40.l("Cannot override _serializer: had a ", ClassUtil.classNameOf(jsonSerializer2), ", trying to set to ", ClassUtil.classNameOf(jsonSerializer)));
        }
    }
