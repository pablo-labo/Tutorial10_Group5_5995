...
public class PropertyBuilder {
    ...
    public Object _throwWrapped(Exception exc, String str, Object obj) {
        ...
        StringBuilder sbM = akb.m("Failed to get property '", str, "' of default ");
    ...
    public JavaType findSerializationType(Annotated annotated, boolean z, JavaType javaType) {
        ...
        if (javaTypeRefineSerializationType != javaType) {
            ...
            if (!rawClass.isAssignableFrom(rawClass2) && !rawClass2.isAssignableFrom(rawClass)) {
                b0.r("Illegal concrete-type annotation for method '", annotated.getName(), "': class ", rawClass.getName(), " not a super-type of (declared) class ", rawClass2.getName());
                return null;
            }
