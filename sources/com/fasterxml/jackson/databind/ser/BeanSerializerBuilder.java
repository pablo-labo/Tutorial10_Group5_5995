...
public class BeanSerializerBuilder {
    ...
    public void setFilteredProperties(BeanPropertyWriter[] beanPropertyWriterArr) {
        if (beanPropertyWriterArr == null || beanPropertyWriterArr.length == this._properties.size()) {
            ...
            t40.q("Trying to set %d filtered properties; must match length of non-filtered `properties` (%d)", new Object[]{Integer.valueOf(beanPropertyWriterArr.length), Integer.valueOf(this._properties.size())});
        }
    }
    ...
    public void setTypeId(AnnotatedMember annotatedMember) {
        if (this._typeId == null) {
            ...
            ia.q("Multiple type ids specified with ", this._typeId, " and ", annotatedMember);
        }
    }
}
