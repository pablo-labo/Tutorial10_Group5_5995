...
public class JacksonAnnotationIntrospector extends AnnotationIntrospector implements Serializable {
    ...
    private List<NamedType> findSubtypesCheckRepeatedNames(String str, JsonSubTypes.Type[] typeArr) {
        ...
        for (JsonSubTypes.Type type : typeArr) {
            ...
            if (!strName.isEmpty() && hashSet.contains(strName)) {
                l5.q(akb.k("Annotated type [", str, "] got repeated subtype name [", strName, "]"));
                return null;
            }
            hashSet.add(strName);
            ...
            while (i < length) {
                ...
                if (!str2.isEmpty() && hashSet.contains(str2)) {
                    l5.q(akb.k("Annotated type [", str, "] got repeated subtype name [", str2, "]"));
                    return list;
                }
                hashSet.add(str2);
    ...
    public String[] findEnumValues(MapperConfig<?> mapperConfig, AnnotatedClass annotatedClass, Enum<?>[] enumArr, String[] strArr) {
        ...
        for (AnnotatedField annotatedField : annotatedClass.fields()) {
            ...
            if (jsonProperty != null && (strValue = jsonProperty.value()) != null && !strValue.isEmpty()) {
    ...
    public TypeResolverBuilder<?> findPropertyContentTypeResolver(MapperConfig<?> mapperConfig, AnnotatedMember annotatedMember, JavaType javaType) {
        ...
        w40.m("Must call method with a container or reference type (got ", javaType, ")");
        return null;
    }
