...
public class BasicBeanDescription extends BeanDescription {
    ...
    public Converter<Object, Object> _createConverter(Object obj) {
        ...
        if (!(obj instanceof Class)) {
            ja.q("AnnotationIntrospector returned Converter definition of type ", obj.getClass().getName(), "; expected type Converter or Class<Converter> instead");
            return null;
        }
        Class cls = (Class) obj;
        if (cls != Converter.None.class && !ClassUtil.isBogusClass(cls)) {
            ...
            r6.g(o6.e(cls, new StringBuilder("AnnotationIntrospector returned Class "), "; expected Class<Converter>"));
        }
        return null;
    }
    ...
    public AnnotatedMember findAnyGetter() {
        ...
        if (pOJOPropertiesCollector != null) {
            ...
            if (anyGetterMethod != null) {
                ...
                l5.q(l5.m("Invalid 'any-getter' annotation on method ", anyGetterMethod.getName(), "(): return type is not instance of java.util.Map"));
                return null;
            }
            ...
            if (anyGetterField != null) {
                ...
                l5.q(l5.m("Invalid 'any-getter' annotation on field '", anyGetterField.getName(), "': type is not instance of java.util.Map"));
            }
        }
        return null;
    }
    ...
    public AnnotatedMember findAnySetterAccessor() {
        ...
        if (pOJOPropertiesCollector != null) {
            ...
            if (anySetterMethod != null) {
                ...
                l5.q(t40.l("Invalid 'any-setter' annotation on method '", anySetterMethod.getName(), "()': first argument not of type String or Object, but ", rawParameterType.getName()));
                return null;
            }
            ...
            if (anySetterField != null) {
                ...
                l5.q(l5.m("Invalid 'any-setter' annotation on field '", anySetterField.getName(), "': type is not instance of `java.util.Map` or `JsonNode`"));
                return null;
            }
        }
        return null;
        ...
        for (BeanPropertyDefinition beanPropertyDefinition : _properties()) {
            ...
            if (referencePropertyFindReferenceType != null && referencePropertyFindReferenceType.isBackReference()) {
                ...
                if (arrayList == null) {
                    ...
                    bg.m(ClassUtil.name(name), "Multiple back-reference properties with name ");
                    return null;
                }
