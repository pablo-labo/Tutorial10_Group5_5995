...
public class UUIDDeserializer extends FromStringDeserializer<UUID> {
    ...
    private UUID _fromBytes(byte[] bArr, DeserializationContext deserializationContext) throws InvalidFormatException {
        ...
        throw InvalidFormatException.from(deserializationContext.getParser(), w20.k(new StringBuilder("Can only construct UUIDs from byte[16]; got "), bArr.length, " bytes"), bArr, handledType());
    }
