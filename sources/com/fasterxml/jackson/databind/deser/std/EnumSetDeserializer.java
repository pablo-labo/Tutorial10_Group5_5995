...
public class EnumSetDeserializer extends StdDeserializer<EnumSet<?>> implements ContextualDeserializer {
    ...
    public EnumSetDeserializer(JavaType javaType, JsonDeserializer<?> jsonDeserializer, TypeDeserializer typeDeserializer) {
        ...
        if (!javaType.isEnumType()) {
            w40.m("Type ", javaType, " not Java Enum type");
            throw null;
        }
        ...
        while (true) {
            try {
                ...
                if (jsonTokenNextToken != JsonToken.VALUE_NULL) {
                    ...
                    enumDeserialize = typeDeserializer == null ? jsonDeserializer.deserialize(jsonParser, deserializationContext) : (Enum) jsonDeserializer.deserializeWithType(jsonParser, deserializationContext, typeDeserializer);
    ...
    public JsonDeserializer<?> createContextual(DeserializationContext deserializationContext, BeanProperty beanProperty) {
        ...
        JsonDeserializer<?> jsonDeserializerFindContextualValueDeserializer = jsonDeserializer == null ? deserializationContext.findContextualValueDeserializer(javaType, beanProperty) : deserializationContext.handleSecondaryContextualization(jsonDeserializer, beanProperty, javaType);
        ...
        return withResolved(jsonDeserializerFindContextualValueDeserializer, typeDeserializerForProperty, findContentNullProvider(deserializationContext, beanProperty, jsonDeserializerFindContextualValueDeserializer), boolFindFormatFeature);
    }
