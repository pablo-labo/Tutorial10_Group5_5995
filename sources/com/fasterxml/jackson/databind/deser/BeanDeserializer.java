...
public class BeanDeserializer extends BeanDeserializerBase implements Serializable {
    ...
    public Object _deserializeUsingPropertyBased(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        while (jsonTokenCurrentToken == JsonToken.FIELD_NAME) {
            ...
            if (propertyValueBufferStartBuilding.readIdProperty(strCurrentName) && settableBeanPropertyFindCreatorProperty == null) {
                ...
                if (activeView != null && !settableBeanPropertyFindCreatorProperty.visibleInView(activeView)) {
                    ...
                    return deserialize(jsonParser3, deserializationContext3, objHandleUnknownProperties);
                }
                jsonParser2 = jsonParser;
                deserializationContext2 = deserializationContext;
            } else {
                ...
                if (settableBeanPropertyFind != null && (!this._beanType.isRecordType() || (settableBeanPropertyFind instanceof MethodProperty))) {
                    try {
                        propertyValueBufferStartBuilding.bufferProperty(settableBeanPropertyFind, _deserializeWithErrorWrapping(jsonParser2, deserializationContext2, settableBeanPropertyFind));
                    } catch (UnresolvedForwardReference e2) {
                        BeanReferring beanReferringHandleUnresolvedReference = handleUnresolvedReference(deserializationContext2, settableBeanPropertyFind, propertyValueBufferStartBuilding, e2);
                        if (arrayList == null) {
        ...
        try {
            Object objBuild = propertyBasedCreator.build(deserializationContext4, propertyValueBufferStartBuilding);
            if (this._injectables != null) {
            ...
            return tokenBufferBufferForInputBuffering != null ? objBuild.getClass() != this._beanType.getRawClass() ? handlePolymorphic(null, deserializationContext4, jsonParser4.streamReadConstraints(), objBuild, tokenBufferBufferForInputBuffering) : handleUnknownProperties(deserializationContext4, objBuild, tokenBufferBufferForInputBuffering) : objBuild;
        } catch (Exception e4) {
    ...
    */
    ...
    public Object deserializeWithUnwrapped(JsonParser jsonParser, DeserializationContext deserializationContext, Object obj) throws JsonMappingException {
        JsonToken jsonTokenCurrentToken = jsonParser.currentToken();
