...
public class AbstractDeserializer extends JsonDeserializer<Object> implements ContextualDeserializer, Serializable {
    ...
    public Object _deserializeFromObjectId(JsonParser jsonParser, DeserializationContext deserializationContext) throws UnresolvedForwardReference {
        ...
        throw new UnresolvedForwardReference(jsonParser, v40.e(objectReference, "Could not resolve Object Id [", "] -- unresolved forward-reference?"), jsonParser.currentLocation(), readableObjectIdFindObjectId);
    }
    ...
    public JsonDeserializer<?> createContextual(DeserializationContext deserializationContext, BeanProperty beanProperty) throws InvalidDefinitionException {
        ...
        if (generatorType == ObjectIdGenerators$PropertyGenerator.class) {
            ...
            if (settableBeanProperty2 == null) {
                deserializationContext.reportBadDefinition(this._baseType, t40.l("Invalid Object Id definition for ", ClassUtil.nameOf(handledType()), ": cannot find property with name ", ClassUtil.name(propertyName)));
            }
