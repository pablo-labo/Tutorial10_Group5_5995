                    ...
                    if (settableBeanPropertyFindCreatorProperty == null) {
                        ...
                        try {
                            ...
                            if (objDeserializeSetAndReturn.getClass() != this._beanType.getRawClass()) {
                                ...
                                return deserializationContext.reportBadDefinition(javaType, t40.l("Cannot support implicit polymorphic deserialization for POJOs-as-Arrays style: nominal type ", ClassUtil.getTypeDescription(javaType), ", actual type ", objDeserializeSetAndReturn.getClass().getName()));
                            }
                        } catch (Exception e2) {
