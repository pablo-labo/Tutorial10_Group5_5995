                    ...
                    if (settableBeanPropertyFindCreatorProperty == null) {
                        ...
                        try {
                            ...
                            if (objBuild.getClass() != this._beanType.getRawClass()) {
                                ...
                                deserializationContext.reportBadDefinition(javaType, t40.l("Cannot support implicit polymorphic deserialization for POJOs-as-Arrays style: nominal type ", ClassUtil.getTypeDescription(javaType), ", actual type ", ClassUtil.getClassDescription(objBuild)));
                            }
                        } catch (Exception e2) {
