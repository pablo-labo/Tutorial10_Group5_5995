    ...
    public JsonDeserializer<Object> deserializerInstance(Annotated annotated, Object obj) {
        ...
        if (!(obj instanceof JsonDeserializer)) {
            if (!(obj instanceof Class)) {
                ja.q("AnnotationIntrospector returned deserializer definition of type ", obj.getClass().getName(), "; expected type JsonDeserializer or Class<JsonDeserializer> instead");
                return null;
            }
            Class cls = (Class) obj;
            if (cls != JsonDeserializer.None.class && !ClassUtil.isBogusClass(cls)) {
                if (JsonDeserializer.class.isAssignableFrom(cls)) {
                    ...
                    r6.g(o6.e(cls, new StringBuilder("AnnotationIntrospector returned Class "), "; expected Class<JsonDeserializer>"));
                }
            }
            return null;
        }
        ...
        if (!(obj instanceof KeyDeserializer)) {
            ...
            if (cls != KeyDeserializer.None.class && !ClassUtil.isBogusClass(cls)) {
                if (KeyDeserializer.class.isAssignableFrom(cls)) {
                    ...
                    r6.g(o6.e(cls, new StringBuilder("AnnotationIntrospector returned Class "), "; expected Class<KeyDeserializer>"));
                }
            }
            return null;
        }
