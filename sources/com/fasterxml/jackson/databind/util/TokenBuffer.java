...
public class TokenBuffer extends JsonGenerator {
    ...
    private void _copyBufferValue(JsonParser jsonParser, JsonToken jsonToken) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$fasterxml$jackson$core$JsonToken[jsonToken.ordinal()]) {
            ...
            case 12:
                ...
                break;
            default:
                j6.f(jsonToken, "Internal error: unexpected token: ");
                break;
        }
    }
            ...
            switch (AnonymousClass1.$SwitchMap$com$fasterxml$jackson$core$JsonToken[jsonTokenType.ordinal()]) {
                ...
                case 8:
                    ...
                    if (obj4 instanceof Double) {
                        ...
                        _reportError("Unrecognized value type for VALUE_NUMBER_FLOAT: " + obj4.getClass().getName() + ", cannot serialize");
                    } else {
                ...
                case 12:
                    ...
                    break;
                default:
                    b0.o("Internal error: should never end up through this code path");
                    return;
            }
        }
    }
    ...
    public String toString() {
        StringBuilder sbG = q6.g("[TokenBuffer: ");
        ...
        while (true) {
            try {
                ...
                if (z) {
                    _appendNativeIds(sbG);
                }
                if (i < 100) {
                    if (i > 0) {
                        sbG.append(", ");
                    }
                    sbG.append(jsonTokenNextToken.toString());
                    if (jsonTokenNextToken == JsonToken.FIELD_NAME) {
                        sbG.append('(');
                        sbG.append(jsonParserAsParser.currentName());
                        sbG.append(')');
                    }
                }
                i++;
    ...
    public static final class Parser extends ParserMinimalBase {
        ...
        private Number getNumberValue(boolean z) throws JsonParseException {
            ...
            if (!(obj_currentObject instanceof String)) {
                o6.k(ClassUtil.classNameOf(obj_currentObject), "Internal error: entry should be a Number, but is of type ");
                return null;
            }
            ...
            r6.g(l5.m("Internal error: failed to parse number '", str, "'"));
            return null;
        }
