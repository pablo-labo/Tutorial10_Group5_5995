...
public final class ClassUtil {
    ...
    private static Method[] _failGetClassMethods(Class<?> cls, Throwable th) {
        ...
        StringBuilder sbF = u40.f("Failed on call to `getDeclaredMethods()` on class `", name, "`, problem: (", name2, ") ");
        sbF.append(message);
        throw new IllegalArgumentException(sbF.toString(), th);
    }
    ...
    public static void checkAndFixAccess(Member member, boolean z) {
        ...
        try {
            ...
            StringBuilder sbF = u40.f("Failed to call `setAccess()` on ", simpleName, " '", name2, "' (of class ");
            ia.r(sbF, strNameOf, ") due to `", name3, "`, problem: ");
            sbF.append(message2);
    ...
    public static <T> T createInstance(Class<T> cls, boolean z) {
        ...
        if (constructorFindConstructor == null) {
            l5.q(o6.e(cls, new StringBuilder("Class "), " has no default (no arg) constructor"));
            return null;
        }
        try {
    ...
    public static Object defaultValue(Class<?> cls) {
        ...
        l5.q(o6.e(cls, new StringBuilder("Class "), " is not a primitive type"));
        return null;
    }
    ...
    public static void verifyMustOverride(Class<?> cls, Object obj, String str) {
        ...
        r6.g(l6.i(u40.f("Sub-class ", obj.getClass().getName(), " (of class ", cls.getName(), ") must override method '"), str, "'"));
    }
    ...
    public static class EnumTypeLocator {
        ...
        private static Field locateField(Class<?> cls, String str, Class<?> cls2) {
            ...
            r6.g(akb.k("No field named '", str, "' in class '", cls.getName(), "'"));
            return null;
        }
        ...
        public Class<? extends Enum<?>> enumTypeFor(EnumSet<?> enumSet) {
            ...
            o6.k(this.failForEnumSet, "Cannot figure out type parameter for `EnumSet` (odd JDK platform?), problem: ");
            return null;
        }
        ...
        public Class<? extends Enum<?>> enumTypeFor(EnumMap<?, ?> enumMap) {
            ...
            o6.k(this.failForEnumMap, "Cannot figure out type parameter for `EnumMap` (odd JDK platform?), problem: ");
            return null;
        }
    }
