...
public class AsPropertyTypeDeserializer extends AsArrayTypeDeserializer {
    ...
    public AsPropertyTypeDeserializer(AsPropertyTypeDeserializer asPropertyTypeDeserializer, BeanProperty beanProperty) {
        ...
        this._msgForMissingId = beanProperty2 == null ? l5.m("missing type id property '", str, "'") : akb.k("missing type id property '", str, "' (for POJO property '", beanProperty2.getName(), "')");
        this._inclusion = asPropertyTypeDeserializer._inclusion;
        this._strictTypeIdHandling = asPropertyTypeDeserializer._strictTypeIdHandling;
    }

    public Object _deserializeTypedForId(JsonParser jsonParser, DeserializationContext deserializationContext, TokenBuffer tokenBuffer, String str) throws JsonMappingException {
    ...
    public AsPropertyTypeDeserializer(JavaType javaType, TypeIdResolver typeIdResolver, String str, boolean z, JavaType javaType2, JsonTypeInfo.As as, boolean z2) {
        ...
        if (beanProperty == null) {
            strK = l5.m("missing type id property '", str2, "'");
        } else {
            strK = akb.k("missing type id property '", str2, "' (for POJO property '", beanProperty.getName(), "')");
        }
        this._msgForMissingId = strK;
        this._inclusion = as;
