...
public class UTF8JsonGenerator extends JsonGeneratorImpl {
    ...
    private final int _outputMultiByteChar(int i, int i2) {
        ...
        if (i < 55296 || i > 57343) {
            ...
            int i3 = i2 + 2;
            bArr[i2 + 1] = (byte) (((i >> 6) & 63) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
            int i4 = i2 + 3;
            bArr[i3] = (byte) ((i & 63) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
            return i4;
        }
        bArr[i2] = 92;
        bArr[i2 + 1] = 117;
    ...
    private final int _outputRawMultiByteChar(int i, char[] cArr, int i2, int i3) throws IOException {
        ...
        int i6 = i4 + 2;
        this._outputTail = i6;
        bArr[i5] = (byte) (((i >> 6) & 63) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
        this._outputTail = i4 + 3;
        bArr[i6] = (byte) ((i & 63) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
        return i2;
    }
            ...
            do {
                ...
                if (c > 127) {
                    ...
                    if (c < 2048) {
                        ...
                        bArr[i4] = (byte) ((c & TracingInterceptor.URL_QUERY_PARAMS_BLOCK_SEPARATOR) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
                    } else {
            ...
            do {
                ...
                if (c > 127) {
                    ...
                    if (c2 < 2048) {
                        ...
                        bArr[i8] = (byte) ((c2 & TracingInterceptor.URL_QUERY_PARAMS_BLOCK_SEPARATOR) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
                        i = i6;
                    } else {
    ...
    private final void _writeStringSegment2(String str, int i, int i2) throws IOException {
        if (l5.c(i2, i, 6, this._outputTail) > this._outputEnd) {
            _flushBuffer();
        }
        ...
        while (i < i2) {
            ...
            if (cCharAt <= 127) {
                ...
                i_outputMultiByteChar += 2;
                bArr[i6] = (byte) ((cCharAt & TracingInterceptor.URL_QUERY_PARAMS_BLOCK_SEPARATOR) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
            } else {
    ...
    private final void _writeStringSegmentASCII2(String str, int i, int i2) throws IOException {
        ...
        while (i < i2) {
            ...
            if (cCharAt <= 127) {
                ...
                bArr[i_outputMultiByteChar] = (byte) ((cCharAt >> 6) | 192);
                i_outputMultiByteChar += 2;
                bArr[i7] = (byte) ((cCharAt & TracingInterceptor.URL_QUERY_PARAMS_BLOCK_SEPARATOR) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
            } else {
                i_outputMultiByteChar = _outputMultiByteChar(cCharAt, i_outputMultiByteChar);
            }
            i = i4;
    ...
    public final void _outputSurrogates(int i, int i2) throws IOException {
        ...
        int i5 = i3 + 2;
        this._outputTail = i5;
        bArr[i4] = (byte) (((i_decodeSurrogate >> 12) & 63) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
        int i6 = i3 + 3;
        this._outputTail = i6;
        bArr[i5] = (byte) (((i_decodeSurrogate >> 6) & 63) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
        this._outputTail = i3 + 4;
        bArr[i6] = (byte) ((i_decodeSurrogate & 63) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
    }
            ...
            do {
                ...
                if (c > 127) {
                    ...
                    if (c < 2048) {
                        ...
                        this._outputTail = i7 + 2;
                        bArr[i8] = (byte) ((c & TracingInterceptor.URL_QUERY_PARAMS_BLOCK_SEPARATOR) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
                    } else {
    ...
    private final void _writeStringSegment2(char[] cArr, int i, int i2) throws IOException {
        ...
        while (i < i2) {
            ...
            if (c <= 127) {
                ...
                i_outputMultiByteChar += 2;
                bArr[i6] = (byte) ((c & TracingInterceptor.URL_QUERY_PARAMS_BLOCK_SEPARATOR) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
            } else {
    ...
    private final void _writeStringSegmentASCII2(char[] cArr, int i, int i2) throws IOException {
        ...
        while (i < i2) {
            ...
            if (c <= 127) {
                ...
                bArr[i_outputMultiByteChar] = (byte) ((c >> 6) | 192);
                i_outputMultiByteChar += 2;
                bArr[i7] = (byte) ((c & TracingInterceptor.URL_QUERY_PARAMS_BLOCK_SEPARATOR) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
            } else {
                i_outputMultiByteChar = _outputMultiByteChar(c, i_outputMultiByteChar);
            }
            i = i4;
    ...
    public void writeRaw(char c) throws IOException {
        ...
        if (c <= 127) {
            ...
            if (c < 2048) {
                ...
                bArr[i3] = (byte) ((c & TracingInterceptor.URL_QUERY_PARAMS_BLOCK_SEPARATOR) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
                return;
            }
