...
public final class CharTypes {
    ...
    static {
        ...
        int[] iArr4 = new int[IntBufferBatchMountItem.INSTRUCTION_UPDATE_EVENT_EMITTER];
        System.arraycopy(iArr3, 0, iArr4, 0, IntBufferBatchMountItem.INSTRUCTION_UPDATE_EVENT_EMITTER);
        Arrays.fill(iArr4, IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT, IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT, 0);
        sInputCodesUtf8JsNames = iArr4;
        int[] iArr5 = new int[IntBufferBatchMountItem.INSTRUCTION_UPDATE_EVENT_EMITTER];
        int[] iArr6 = sInputCodesUTF8;
        System.arraycopy(iArr6, IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT, iArr5, IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT, IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
        ...
        int[] iArr7 = new int[IntBufferBatchMountItem.INSTRUCTION_UPDATE_EVENT_EMITTER];
        System.arraycopy(iArr6, IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT, iArr7, IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT, IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
        ...
        iArr7[35] = 35;
        sInputCodesWS = iArr7;
        int[] iArr8 = new int[IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT];
        ...
        iArrCopyOf[47] = 47;
        int[] iArr9 = new int[IntBufferBatchMountItem.INSTRUCTION_UPDATE_EVENT_EMITTER];
        sHexValues = iArr9;
        Arrays.fill(iArr9, -1);
    ...
    public static class AltEscapes {
        ...
        private int[][] _altEscapes = new int[IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT][];
        private int[][] _altEscapesWithSlash = new int[IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT][];
        ...
        public int[] escapesFor(int i) {
            ...
            if (iArrCopyOf == null) {
                iArrCopyOf = Arrays.copyOf(CharTypes.sOutputEscapes128, IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
                if (iArrCopyOf[i] == 0) {
                    iArrCopyOf[i] = -1;
                }
