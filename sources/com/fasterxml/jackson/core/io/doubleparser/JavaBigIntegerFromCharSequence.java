...
class JavaBigIntegerFromCharSequence extends AbstractBigIntegerParser {
    ...
    private BigInteger parseManyDecDigits(CharSequence charSequence, int i, int i2, boolean z) {
        ...
        BigInteger digitsRecursive = ParseDigitsTaskCharSequence.parseDigitsRecursive(charSequence, iSkipZeroes, i2, FastIntegerMath.fillPowersOf10Floor16(iSkipZeroes, i2), DataOkHttpUploader.HTTP_BAD_REQUEST);
