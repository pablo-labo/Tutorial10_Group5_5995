            ...
            for (int i3 = 0; i3 < i; i3 += i2) {
                ...
                while (true) {
                    ...
                    if (i4 < i5) {
                        ...
                        mutableComplex3.subtract(complexVector, iA);
                        ...
                        mutableComplex4.subtractTimesI(complexVector, iA);
                        ...
                        mutableComplex4.copyInto(complexVector, iA);
                        i4++;
            ...
            while (i8 < i3) {
                ...
                while (true) {
                    ...
                    if (i10 < i11) {
                        ...
                        complexVector.multiplyConjugateInto(iA, mutableComplex9, mutableComplex4);
                        ...
                        mutableComplex8.copyInto(complexVector, iA);
                        i10 = i13 + 1;
