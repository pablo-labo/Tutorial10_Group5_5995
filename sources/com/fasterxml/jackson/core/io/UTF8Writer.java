    ...
    */
    ...
    public void write(int i) throws IOException {
        ...
        if (i < 2048) {
            ...
            i2 = i5 + 2;
            bArr2[i6] = (byte) ((i & 63) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
        } else if (i <= 65535) {
            byte[] bArr3 = this._outBuffer;
            bArr3[i5] = (byte) ((i >> 12) | 224);
            int i7 = i5 + 2;
            bArr3[i5 + 1] = (byte) (((i >> 6) & 63) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
            i2 = i5 + 3;
            bArr3[i7] = (byte) ((i & 63) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
        } else {
            if (i > 1114111) {
                illegalSurrogate(i);
            }
            ...
            bArr4[i5 + 1] = (byte) (((i >> 12) & 63) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
            int i8 = i5 + 3;
            bArr4[i5 + 2] = (byte) (((i >> 6) & 63) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
            i2 = i5 + 4;
            bArr4[i8] = (byte) ((i & 63) | IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
        }
        this._outPtr = i2;
    }
