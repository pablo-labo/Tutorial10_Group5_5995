...
public abstract class ParserMinimalBase extends JsonParser {
    ...
    public void _reportUnexpectedChar(int i, String str) {
        ...
        String strM = l5.m("Unexpected character (", _getCharDesc(i), ")");
        if (str != null) {
            strM = z3.m(strM, ": ", str);
        }
    ...
    public <T> T _reportUnexpectedNumberChar(int i, String str) {
        String strM = l5.m("Unexpected character (", _getCharDesc(i), ") in numeric value");
        if (str != null) {
            strM = z3.m(strM, ": ", str);
        }
        throw _constructReadException(strM, _currentLocationMinusOne());
    ...
    public void _reportInvalidEOF(String str, JsonToken jsonToken) {
        throw new JsonEOFException(this, jsonToken, l5.l("Unexpected end-of-input", str));
    }
