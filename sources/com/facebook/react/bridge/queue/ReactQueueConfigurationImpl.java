...
public final class ReactQueueConfigurationImpl implements ReactQueueConfiguration {
    ...
    public void destroy() {
        if (!wl7.b(this.nativeModulesQueueThread.getLooper(), Looper.getMainLooper())) {
            this.nativeModulesQueueThread.quitSynchronous();
        }
        if (wl7.b(this.jsQueueThread.getLooper(), Looper.getMainLooper())) {
            return;
        }
