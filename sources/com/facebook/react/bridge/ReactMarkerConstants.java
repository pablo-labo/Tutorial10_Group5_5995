...
public final class ReactMarkerConstants {
    ...
    static {
        ...
        $ENTRIES = ojh.k(reactMarkerConstantsArr$values);
    }

    public /* synthetic */ ReactMarkerConstants(String str, int i, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
