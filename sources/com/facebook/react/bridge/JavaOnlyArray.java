...
public final class JavaOnlyArray implements ReadableArray, WritableArray {
    ...
    private JavaOnlyArray(Object... objArr) {
        this.backingList = u63.d0(Arrays.copyOf(objArr, objArr.length));
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || !JavaOnlyArray.class.equals(other.getClass())) {
            return false;
        }
        return wl7.b(this.backingList, ((JavaOnlyArray) other).backingList);
    }
    ...
    public ReadableType getType(int index) {
        ...
        ja.q("Invalid type ", obj.getClass(), ")");
        return null;
    }
