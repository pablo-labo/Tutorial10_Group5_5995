...
public final class ModuleSpec {
    ...
    public static final class Companion {
        ...
        public final ModuleSpec nativeModuleSpec(Class<? extends NativeModule> type, Provider<? extends NativeModule> provider) {
            type.getClass();
            provider.getClass();
            nmc nmcVar = (nmc) type.getAnnotation(nmc.class);
            DefaultConstructorMarker defaultConstructorMarker = null;
            if (nmcVar != null) {
                return new ModuleSpec(provider, nmcVar.name(), defaultConstructorMarker);
            }
            s55.n(ModuleSpec.TAG, "Could not find @ReactModule annotation on " + type.getName() + ". Creating the module eagerly to get the name. Consider adding the annotation.");
