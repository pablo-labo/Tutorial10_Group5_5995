...
public final class RumViewScope$onAddError$2$2 extends mj8 implements Function1<AdvancedRumMonitor, j6g> {
    final /* synthetic */ RumContext $rumContext;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RumViewScope$onAddError$2$2(RumContext rumContext) {
        super(1);
    ...
    public final void invoke2(AdvancedRumMonitor advancedRumMonitor) {
        ...
        advancedRumMonitor.eventSent(viewId, new StorageEvent.Error(null, null, 3, null));
    }
