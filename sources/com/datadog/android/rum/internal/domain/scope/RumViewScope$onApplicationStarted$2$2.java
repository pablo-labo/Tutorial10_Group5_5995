...
public final class RumViewScope$onApplicationStarted$2$2 extends mj8 implements Function1<AdvancedRumMonitor, j6g> {
    final /* synthetic */ RumContext $rumContext;
    final /* synthetic */ StorageEvent.Action $storageEvent;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RumViewScope$onApplicationStarted$2$2(RumContext rumContext, StorageEvent.Action action) {
        super(1);
    ...
    public final void invoke2(AdvancedRumMonitor advancedRumMonitor) {
        ...
        advancedRumMonitor.eventSent(viewId, this.$storageEvent);
    }
