...
public final class DatadogDataConstraints$tagTransforms$4 extends mj8 implements Function1<String, String> {
    public static final DatadogDataConstraints$tagTransforms$4 INSTANCE = new DatadogDataConstraints$tagTransforms$4();

    public DatadogDataConstraints$tagTransforms$4() {
        super(1);
    }
    ...
    public final String invoke(String str) {
        str.getClass();
        return zve.O(str, ':') ? akb.j(1, 0, str) : str;
    }
}
