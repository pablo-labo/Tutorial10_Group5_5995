...
public final class DatadogDataConstraints$tagTransforms$3 extends mj8 implements Function1<String, String> {
    public static final DatadogDataConstraints$tagTransforms$3 INSTANCE = new DatadogDataConstraints$tagTransforms$3();

    public DatadogDataConstraints$tagTransforms$3() {
        super(1);
    }
    ...
    public final String invoke(String str) {
        str.getClass();
        return new pxc("[^a-z0-9_:./-]").e(str, "_");
    }
}
