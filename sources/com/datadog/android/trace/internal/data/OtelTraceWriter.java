...
public final class OtelTraceWriter implements g5h {
    ...
    private final ContextAwareMapper<qc3, SpanEvent> ddSpanToSpanEventMapper;
    private final EventMapper<SpanEvent> eventMapper;
    private final InternalLogger internalLogger;
    private final FeatureSdkCore sdkCore;
    private final ContextAwareSerializer<SpanEvent> serializer;

    /* JADX INFO: renamed from: com.datadog.android.trace.internal.data.OtelTraceWriter$writeSpan$2, reason: invalid class name */
    ...
    public OtelTraceWriter(FeatureSdkCore featureSdkCore, ContextAwareMapper<qc3, SpanEvent> contextAwareMapper, EventMapper<SpanEvent> eventMapper, ContextAwareSerializer<SpanEvent> contextAwareSerializer, InternalLogger internalLogger) {
    ...
    public final void writeSpan(DatadogContext datadogContext, EventBatchWriter writer, qc3 span) {
    ...
    public final ContextAwareMapper<qc3, SpanEvent> getDdSpanToSpanEventMapper$dd_sdk_android_trace_release() {
    ...
    public void write(List<qc3> trace) {
    ...
    @Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\"\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u001a\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007R\u000e\u0010\b\u001a\u00020\tX\u0080T¢\u0006\u0002\n\u0000¨\u0006\n"}, d2 = {"Lcom/datadog/android/trace/internal/data/OtelTraceWriter$Companion;", "", "()V", "DROP_SAMPLING_PRIORITIES", "", "", "getDROP_SAMPLING_PRIORITIES$dd_sdk_android_trace_release", "()Ljava/util/Set;", "ERROR_SERIALIZING", "", "dd-sdk-android-trace_release"}, k = 1, mv = {1, 7, 0}, xi = 48)
    public static final class Companion {
        ...
        public final Set<Integer> getDROP_SAMPLING_PRIORITIES$dd_sdk_android_trace_release() {
            return OtelTraceWriter.DROP_SAMPLING_PRIORITIES;
        }
    ...
    public /* synthetic */ OtelTraceWriter(FeatureSdkCore featureSdkCore, ContextAwareMapper contextAwareMapper, EventMapper eventMapper, ContextAwareSerializer contextAwareSerializer, InternalLogger internalLogger, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(featureSdkCore, contextAwareMapper, (i & 4) != 0 ? new NoOpEventMapper() : eventMapper, contextAwareSerializer, internalLogger);
    }

    /* JADX INFO: renamed from: com.datadog.android.trace.internal.data.OtelTraceWriter$write$1, reason: invalid class name */
    ...
    public static final class AnonymousClass1 extends mj8 implements Function2<DatadogContext, EventBatchWriter, j6g> {
        final /* synthetic */ List<qc3> $trace;
        final /* synthetic */ OtelTraceWriter this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass1(List<qc3> list, OtelTraceWriter otelTraceWriter) {
            super(2);
            this.$trace = list;
            this.this$0 = otelTraceWriter;
        }
        ...
        public final void invoke2(DatadogContext datadogContext, EventBatchWriter eventBatchWriter) {
            ...
            List<qc3> list = this.$trace;
            ArrayList arrayList = new ArrayList();
            Iterator<T> it = list.iterator();
            if (it.hasNext()) {
                qc3 qc3Var = (qc3) it.next();
                OtelTraceWriter.INSTANCE.getDROP_SAMPLING_PRIORITIES$dd_sdk_android_trace_release();
                qc3Var.getClass();
                throw null;
            }
            ...
            while (it2.hasNext()) {
                otelTraceWriter.writeSpan(datadogContext, eventBatchWriter, (qc3) it2.next());
            }
        }
