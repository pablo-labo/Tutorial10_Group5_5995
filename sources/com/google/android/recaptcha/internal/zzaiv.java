...
final class zzaiv {
    ...
    private static final zzaiu zzf;
    ...
    static {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.recaptcha.internal.zzaiv.<clinit>():void");
    }
    ...
    public static Unsafe zzg() {
        try {
            return (Unsafe) AccessController.doPrivileged(new zzair());
        } catch (Throwable unused) {
            return null;
        }
    }
    ...
    public static /* bridge */ /* synthetic */ void zzh(Throwable th) {
        Logger.getLogger(zzaiv.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
    }
