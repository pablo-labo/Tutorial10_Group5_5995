...
final class zzaha extends zzads implements RandomAccess, zzagm, zzahu {
    private static final long[] zza;
    private static final zzaha zzb;
    private long[] zzc;
    private int zzd;
    ...
    public final boolean addAll(Collection collection) {
        ...
        byte[] bArr = zzago.zzb;
        collection.getClass();
        if (!(collection instanceof zzaha)) {
            return super.addAll(collection);
        }
        zzaha zzahaVar = (zzaha) collection;
        int i = zzahaVar.zzd;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(zzahaVar.zzc, 0, this.zzc, this.zzd, zzahaVar.zzd);
        this.zzd = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzd != zzahaVar.zzd) {
            return false;
        }
        long[] jArr = zzahaVar.zzc;
    ...
    public final /* bridge */ /* synthetic */ zzagn zzd(int i) {
        if (i >= this.zzd) {
            return new zzaha(i == 0 ? zza : Arrays.copyOf(this.zzc, i), this.zzd, true);
        }
        o6.h();
        return null;
    }
    ...
    private zzaha(long[] jArr, int i, boolean z) {
        super(z);
        this.zzc = jArr;
        this.zzd = i;
    }
