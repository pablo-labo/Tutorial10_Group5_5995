...
final class zzaiy {
    ...
    public static String zzd(byte[] bArr, int i, int i2) {
        ...
        if ((((length - i) - i2) | i | i2) < 0) {
            r6.i("buffer length=%d, index=%d, size=%d", new Object[]{Integer.valueOf(length), Integer.valueOf(i), Integer.valueOf(i2)});
            return null;
        }
        int i4 = i + i2;
        ...
        while (i < i4) {
            ...
            if (zzaiw.zzd(b2)) {
                ...
                if (b2 < -32) {
                    ...
                    int i8 = i + 2;
                    i += 3;
                    zzaiw.zzb(b2, bArr[i7], bArr[i8], cArr, i6);
                } else {
                    if (i7 >= i4 - 2) {
                        ia.p("Protocol message had invalid UTF-8.");
                        return null;
                    ...
                    byte b5 = bArr[i + 2];
                    i += 4;
                    zzaiw.zza(b2, b4, b5, bArr[i9], cArr, i6);
                    i6 += 2;
                }
                i6 = i3;
            }
    ...
    */
    public static boolean zze(byte[] r6, int r7, int r8) {
        ...
        L7a:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.recaptcha.internal.zzaiy.zze(byte[], int, int):boolean");
    }
}
