...
final class zzafl extends zzads implements RandomAccess, zzagn, zzahu {
    ...
    public final boolean addAll(Collection collection) {
        ...
        byte[] bArr = zzago.zzb;
        collection.getClass();
        if (!(collection instanceof zzafl)) {
            return super.addAll(collection);
        }
        zzafl zzaflVar = (zzafl) collection;
        int i = zzaflVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(zzaflVar.zzb, 0, this.zzb, this.zzc, zzaflVar.zzc);
        this.zzc = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzaflVar.zzc) {
            return false;
        }
        double[] dArr = zzaflVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzagn zzd(int i) {
        if (i >= this.zzc) {
            return new zzafl(i == 0 ? zza : Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
        o6.h();
        return null;
    }
    ...
    private zzafl(double[] dArr, int i, boolean z) {
        super(z);
        this.zzb = dArr;
        this.zzc = i;
    }
