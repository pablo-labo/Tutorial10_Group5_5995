...
final class zzahw extends zzads implements RandomAccess {
    ...
    public final /* bridge */ /* synthetic */ zzagn zzd(int i) {
        if (i >= this.zzd) {
            return new zzahw(i == 0 ? zza : Arrays.copyOf(this.zzc, i), this.zzd, true);
        }
        o6.h();
        return null;
    }
    ...
    private zzahw(Object[] objArr, int i, boolean z) {
        super(z);
        this.zzc = objArr;
        this.zzd = i;
    }
