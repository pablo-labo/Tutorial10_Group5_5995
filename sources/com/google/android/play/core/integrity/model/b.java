...
public final class b {
    ...
    public static String a(int i) {
        ...
        Map map2 = b;
        return !map2.containsKey(numValueOf) ? "" : o6.f((String) map.get(numValueOf), " (https://developer.android.com/google/play/integrity/reference/com/google/android/play/core/integrity/model/StandardIntegrityErrorCode.html#", (String) map2.get(numValueOf), ")");
    }
}
