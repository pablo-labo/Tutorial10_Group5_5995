...
public final class ViewStubCompat extends View {
    ...
    public ViewStubCompat(Context context, AttributeSet attributeSet) {
        ...
        this.a = 0;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, wac.B, 0, 0);
    ...
    public final View a() {
        ...
        if (!(parent instanceof ViewGroup)) {
            r6.g("ViewStub must have a non-null ViewGroup viewParent");
            return null;
        }
        if (this.a == 0) {
            l5.q("ViewStub must have a valid layoutResource");
            return null;
        }
    ...
    public void setVisibility(int i) {
        ...
        if (weakReference != null) {
            ...
            if (view != null) {
                ...
                r6.g("setVisibility called on un-referenced view");
                return;
            }
        }
