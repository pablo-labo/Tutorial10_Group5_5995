...
public final class h implements pze {
    public m7 A;
    ...
    public final boolean e() {
        ...
        if (this.z == null && (m7Var = this.A) != null) {
            this.z = m7Var.d(this);
        }
        return this.z != null;
    }
    ...
    @Override // defpackage.pze, android.view.MenuItem
    ...
    public final Drawable getIcon() {
        ...
        Drawable drawableA = pnb.A(this.n.a, i);
        this.m = 0;
        this.l = drawableA;
        return d(drawableA);
    }
    ...
    public final boolean isVisible() {
        m7 m7Var = this.A;
        return (m7Var == null || !m7Var.g()) ? (this.x & 8) == 0 : (this.x & 8) == 0 && this.A.b();
    }
    ...
    @Override // defpackage.pze, android.view.MenuItem
    public final pze setContentDescription(CharSequence charSequence) {
        this.q = charSequence;
        this.n.p(false);
        return this;
    }
    ...
    public final void setShowAsAction(int i) {
        int i2 = i & 3;
        if (i2 != 0 && i2 != 1 && i2 != 2) {
            l5.q("SHOW_AS_ACTION_ALWAYS, SHOW_AS_ACTION_IF_ROOM, and SHOW_AS_ACTION_NEVER are mutually exclusive.");
            return;
        }
        this.y = i;
        f fVar = this.n;
    ...
    @Override // defpackage.pze, android.view.MenuItem
    public final pze setTooltipText(CharSequence charSequence) {
        this.r = charSequence;
        this.n.p(false);
        return this;
    }
