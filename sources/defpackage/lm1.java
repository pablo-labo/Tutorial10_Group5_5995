...
public final class lm1 implements jm1 {
    ...
    public lm1(LaunchActivity launchActivity, Function1<? super nhb, j6g> function1, Function1<? super ShowSearchOverlayData, j6g> function12, Function1<? super DisplayToastData, j6g> function13) {
    ...
    public final void a(Command command, BridgeDispatcher.c cVar) {
        command.getClass();
        rm1.a(this.a, command, cVar, this.b, this.c, this.d);
    }
}
