...
public final class gyg implements xu5<xo8, Integer, b, Integer, j6g> {
    public final /* synthetic */ List a;
    public final /* synthetic */ String b;
    public final /* synthetic */ Function1 c;

    public gyg(String str, List list, Function1 function1) {
        this.a = list;
        this.b = str;
        this.c = function1;
    }
    ...
    public final j6g j(xo8 xo8Var, Integer num, b bVar, Integer num2) {
        ...
        if (bVar2.o(i & 1, (i & 147) != 146)) {
            ...
            Object objV = bVar2.v();
            if (zK || objV == b.a.a) {
                objV = new cyg(function1, iIntValue);
                bVar2.p(objV);
            }
            jyg.d(zyeVar, this.b, (gu5) objV, p6.c(iIntValue, "InitialSuggestionItem"), bVar2, 0);
            bVar2.F();
        } else {
            bVar2.D();
        }
