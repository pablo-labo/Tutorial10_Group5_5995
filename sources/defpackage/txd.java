...
public final class txd extends ye4.a {
    public txd(ue4 ue4Var, ve4 ve4Var, ve4 ve4Var2, boolean z) {
    ...
    public final ye4 a(ye4 ye4Var) {
        ...
        if (h91.F(pxdVar5.d)) {
            ...
            pxd pxdVar11 = (pxd) ve4VarD2.n().a(ve4VarD2).a(pxdVar10).b();
            if (h91.F(pxdVar11.d)) {
                return new txd(ue4Var, pxdVar11, sxd.i, this.e);
            }
            ...
            if (h91.F(jArr4)) {
                return new txd(ue4Var, pxdVar13, sxd.i, this.e);
            }
        ...
        ve4VarArr[i] = pxdVar3;
        return new txd(ue4Var, pxdVar, pxdVar2, ve4VarArr, this.e);
    }
    ...
    public final ye4 h() {
        if (!f()) {
            ...
            if (!ve4Var.h()) {
                ...
                boolean z = this.e;
                return new txd(this.a, ve4Var, this.c.a(ve4Var2), new ve4[]{ve4Var2}, z);
            }
        }
        return this;
    }
    ...
    public final ye4 m() {
        ...
        pxd pxdVar = (pxd) this.b;
        boolean zF = h91.F(pxdVar.d);
        ue4 ue4Var = this.a;
        if (zF) {
            return ue4Var.i();
        }
        pxd pxdVar2 = (pxd) this.c;
        pxd pxdVar3 = (pxd) this.d[0];
        long[] jArr2 = new long[9];
        long[] jArr3 = new long[9];
        boolean zG = pxdVar3.g();
        long[] jArr4 = pxdVar3.d;
        long[] jArrB = zG ? null : w74.B(jArr4);
        if (jArrB == null) {
            jArr = pxdVar2.d;
        } else {
            w74.y(pxdVar2.d, jArrB, jArr2);
            w74.E(jArr4, jArr3);
            jArr = jArr2;
            jArr4 = jArr3;
        }
        long[] jArr5 = new long[9];
        w74.E(pxdVar2.d, jArr5);
        for (int i = 0; i < 9; i++) {
            jArr5[i] = jArr5[i] ^ (jArr[i] ^ jArr4[i]);
        }
        if (h91.F(jArr5)) {
            return new txd(ue4Var, new pxd(jArr5), sxd.i, this.e);
        }
        long[] jArr6 = new long[18];
        w74.x(jArr5, jArr, jArr6);
        pxd pxdVar4 = new pxd(jArr2);
        w74.E(jArr5, jArr2);
        pxd pxdVar5 = new pxd(jArr5);
        if (jArrB != null) {
            w74.w(jArr5, jArr4, jArr5);
        }
        long[] jArr7 = pxdVar.d;
        if (jArrB != null) {
            w74.y(jArr7, jArrB, jArr3);
            jArr7 = jArr3;
        }
        long[] jArr8 = new long[18];
        w74.p(jArr7, jArr8);
        for (int i2 = 0; i2 < 18; i2++) {
            jArr6[i2] = jArr6[i2] ^ jArr8[i2];
        }
        w74.C(jArr6, jArr3);
        for (int i3 = 0; i3 < 9; i3++) {
            jArr3[i3] = jArr3[i3] ^ (jArr2[i3] ^ jArr5[i3]);
        }
        return new txd(ue4Var, pxdVar4, new pxd(jArr3), new ve4[]{pxdVar5}, this.e);
    }

    public txd(ue4 ue4Var, ve4 ve4Var, ve4 ve4Var2, ve4[] ve4VarArr, boolean z) {
