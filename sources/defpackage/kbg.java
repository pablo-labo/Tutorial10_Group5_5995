...
public final class kbg implements ga<ibg.a> {
    public static final kbg a = new kbg();
    public static final List<String> b = u63.Z("__typename");

    @Override // defpackage.ga
    public final ibg.a a(mb8 mb8Var, lb3 lb3Var) {
        mb8Var.getClass();
        lb3Var.getClass();
        String str = null;
        while (mb8Var.D1(b) == 0) {
    ...
    @Override // defpackage.ga
    public final void b(hc8 hc8Var, lb3 lb3Var, ibg.a aVar) {
        ibg.a aVar2 = aVar;
        hc8Var.getClass();
        lb3Var.getClass();
        aVar2.getClass();
