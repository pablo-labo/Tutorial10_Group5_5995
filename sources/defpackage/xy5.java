...
public final class xy5 extends mj8 implements Function1<lx5.b, j6g> {
    ...
    public xy5(String str, String str2, String str3, Function1<? super lx5.b, j6g> function1) {
        super(1);
    ...
    public final j6g invoke(lx5.b bVar) {
        lx5.b bVar2 = bVar;
        bVar2.getClass();
        bVar2.a("webviewName", this.$webviewName);
        bVar2.a("url", this.$url);
        bVar2.a("bltk", this.$bltk);
