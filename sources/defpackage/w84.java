...
public final class w84 {
    ...
    public static boolean a(double d) {
        if (hh1.F(d)) {
            return d == 0.0d || 52 - Long.numberOfTrailingZeros(hh1.B(d)) <= Math.getExponent(d);
        }
        return false;
    }
    ...
    */
    public static int c(double r6) {
        /*
            ...
            r3 = 1
            if (r1 <= 0) goto L12
            boolean r1 = defpackage.hh1.F(r6)
            if (r1 == 0) goto L12
            r1 = r3
            goto L13
        L12:
        ...
        L79:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.w84.c(double):int");
    }
}
