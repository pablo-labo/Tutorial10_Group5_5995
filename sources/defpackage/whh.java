...
public final class whh {
    ...
    public static Intent a(Context context, jii jiiVar) throws zzaf {
        Bundle bundleCall;
        ...
        if (jiiVar.c) {
            Bundle bundleE = l6.e("serviceActionBundleKey", str);
            try {
                contentProviderClientAcquireUnstableContentProviderClient = context.getContentResolver().acquireUnstableContentProviderClient(a);
        ...
        return intent == null ? new Intent(str).setPackage(jiiVar.b) : intent;
    }
}
