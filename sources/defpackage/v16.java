...
public final class v16 implements ga<q16.d> {
    public static final v16 a = new v16();
    ...
    public final q16.d a(mb8 mb8Var, lb3 lb3Var) {
        Object objA;
        mb8Var.getClass();
        lb3Var.getClass();
        String str = null;
        ...
        while (true) {
            switch (mb8Var.D1(b)) {
                ...
                default:
                    if (str != null) {
                        return new q16.d(str, strA, strA2, t18Var, strA3, strA4, strA5, strA6, objA2);
                    }
                    mh2.q(mb8Var, "id");
                    throw null;
            }
    ...
    @Override // defpackage.ga
    public final void b(hc8 hc8Var, lb3 lb3Var, q16.d dVar) {
        q16.d dVar2 = dVar;
        hc8Var.getClass();
        lb3Var.getClass();
        dVar2.getClass();
        ...
        nmaVar.b(hc8Var, lb3Var, dVar2.f);
        hc8Var.u0("extension");
        nmaVar.b(hc8Var, lb3Var, dVar2.g);
        hc8Var.u0("standardHashCode");
        nmaVar.b(hc8Var, lb3Var, dVar2.h);
        hc8Var.u0("uploadTimestamp");
        ha.m.b(hc8Var, lb3Var, dVar2.i);
    }
}
