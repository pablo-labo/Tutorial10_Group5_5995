...
public final class vjg {
    ...
    public static class a {
        public static void a(Service service, Notification notification) {
            try {
                ...
                zkd.w("Util", "The service must be declared with a foregroundServiceType that includes mediaPlayback");
                throw e;
            }
        }
    }
    ...
    static {
        ...
        i = new String[]{"alb", "sq", "arm", "hy", "baq", "eu", "bur", "my", "tib", "bo", "chi", "zh", "cze", "cs", "dut", "nl", "ger", "de", "gre", "el", "fre", "fr", "geo", "ka", "ice", "is", "mac", "mk", "mao", "mi", "may", "ms", "per", "fa", "rum", "ro", "scc", "hbs-srp", "slo", "sk", "wel", "cy", "id", "ms-ind", "iw", "he", "heb", "he", "ji", "yi", "arb", "ar-arb", "in", "ms-ind", "ind", "ms-ind", "nb", "no-nob", "nob", "no-nob", "nn", "no-nno", "nno", "no-nno", "tw", "ak-twi", "twi", "ak-twi", "bs", "hbs-bos", "bos", "hbs-bos", "hr", "hbs-hrv", "hrv", "hbs-hrv", BatchMetricsDispatcher.SR_TRACK_NAME, "hbs-srp", "srp", "hbs-srp", "cmn", "zh-cmn", "hak", "zh-hak", "nan", "zh-nan", "hsn", "zh-hsn"};
        ...
        m = new int[]{0, 7, 14, 9, 28, 27, 18, 21, 56, 63, 54, 49, 36, 35, 42, 45, 112, 119, 126, 121, 108, 107, 98, 101, 72, 79, 70, 65, 84, 83, 90, 93, 224, 231, 238, 233, 252, 251, 242, 245, 216, 223, 214, 209, 196, 195, DataOkHttpUploader.HTTP_ACCEPTED, 205, 144, 151, 158, 153, 140, 139, 130, 133, 168, 175, 166, 161, 180, 179, 186, 189, 199, 192, 201, 206, 219, 220, 213, 210, 255, 248, 241, 246, 227, 228, 237, 234, 183, 176, 185, 190, 171, 172, 165, 162, 143, 136, 129, 134, 147, 148, 157, 154, 39, 32, 41, 46, 59, 60, 53, 50, 31, 24, 17, 22, 3, 4, 13, 10, 87, 80, 89, 94, 75, 76, 69, 66, 111, 104, 97, 102, 115, 116, 125, 122, 137, 142, 135, IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT, 149, 146, 155, 156, 177, 182, 191, 184, 173, 170, 163, 164, 249, 254, 247, 240, 229, 226, 235, 236, 193, 198, 207, UiRumDebugListener.DEFAULT_ALPHA, 221, 218, 211, 212, 105, 110, 103, 96, 117, 114, 123, 124, 81, 86, 95, 88, 77, 74, 67, 68, 25, 30, 23, 16, 5, 2, 11, 12, 33, 38, 47, 40, 61, 58, 51, 52, 78, 73, 64, 71, 82, 85, 92, 91, 118, 113, 120, 127, 106, 109, 100, 99, 62, 57, 48, 55, 34, 37, 44, 43, 6, 1, 8, 15, 26, 29, 20, 19, 174, 169, 160, 167, 178, 181, 188, 187, 150, 145, 152, 159, 138, 141, 132, 131, 222, 217, 208, 215, 194, 197, 204, 203, 230, 225, 232, 239, 250, 253, 244, 243};
    }
    ...
    public static String E(String str) {
        try {
            ...
            zkd.x("Util", "Failed to read system property ".concat(str), e2);
            return null;
        }
    }
    ...
    public static String F(int i2) {
        switch (i2) {
            ...
            default:
                return i2 >= 10000 ? bg.d(i2, "custom (", ")") : CoreFeature.DEFAULT_APP_VERSION;
        }
    }
    ...
    */
    public static boolean G(defpackage.gdb r4) {
        /*
            r0 = 0
            if (r4 != 0) goto L4
            return r0
        ...
        L2e:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.vjg.G(gdb):boolean");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static int H(android.net.Uri r7, java.lang.String r8) {
        /*
            Method dump skipped, instruction units count: 286
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.vjg.H(android.net.Uri, java.lang.String):int");
    }

    public static boolean I(g4b g4bVar, g4b g4bVar2, Inflater inflater) {
        if (g4bVar.a() == 0) {
            return false;
        }
        if (g4bVar2.a.length < g4bVar.a()) {
            g4bVar2.c(g4bVar.a() * 2);
        }
        if (inflater == null) {
            inflater = new Inflater();
        }
        inflater.setInput(g4bVar.a, g4bVar.b, g4bVar.a());
        int iInflate = 0;
        while (true) {
            try {
                byte[] bArr = g4bVar2.a;
    ...
    public static boolean K(Context context) {
        ...
        if (i2 == 30) {
            ...
            if (jh2.k(str, "moto g(20)") || jh2.k(str, "rmx3231")) {
                return true;
            }
        }
        return i2 == 34 && jh2.k(Build.MODEL, "sm-x200");
    }
    ...
    public static void N(int i2, int i3, int i4, ArrayList arrayList) {
    ...
    public static Object[] Q(int i2, Object[] objArr) {
        ka2.l(i2 <= objArr.length);
        return Arrays.copyOf(objArr, i2);
    }

    public static long R(String str) throws ParserException {
    ...
    public static int S(long j2, long j3) {
        long jD = h59.d(j2, 100L);
        return bm7.K1((jD == Long.MAX_VALUE || jD == Long.MIN_VALUE) ? j2 / (j3 / 100) : jD / j3);
    }
    ...
    public static void U(ArrayList arrayList, int i2, int i3) {
    ...
    public static void W(long[] jArr, long j2) {
        long j3;
        RoundingMode roundingMode = RoundingMode.DOWN;
        int i2 = 0;
        if (j2 >= 1000000 && j2 % 1000000 == 0) {
            long jB = h59.b(j2, 1000000L, RoundingMode.UNNECESSARY);
            while (i2 < jArr.length) {
                jArr[i2] = h59.b(jArr[i2], jB, roundingMode);
                i2++;
            }
            return;
        }
        if (j2 < 1000000 && 1000000 % j2 == 0) {
            long jB2 = h59.b(1000000L, j2, RoundingMode.UNNECESSARY);
            while (i2 < jArr.length) {
                jArr[i2] = h59.d(jArr[i2], jB2);
                i2++;
            }
            return;
        }
        ...
        while (i3 < jArr.length) {
            ...
            if (j4 != 0) {
                if (j2 >= j4 && j2 % j4 == 0) {
                    jArr[i3] = h59.b(1000000L, h59.b(j2, j4, RoundingMode.UNNECESSARY), roundingMode);
                } else if (j2 >= j4 || j4 % j2 != 0) {
                    j3 = j2;
                    jArr[i3] = Y(j4, 1000000L, j3, roundingMode);
                } else {
                    jArr[i3] = h59.d(1000000L, h59.b(j4, j2, RoundingMode.UNNECESSARY));
                }
                j3 = j2;
            } else {
                j3 = j2;
    ...
    public static long X(long j2, long j3, long j4, RoundingMode roundingMode) {
        ...
        return (j4 < j3 || j4 % j3 != 0) ? (j4 >= j3 || j3 % j4 != 0) ? (j4 < j2 || j4 % j2 != 0) ? (j4 >= j2 || j2 % j4 != 0) ? Y(j2, j3, j4, roundingMode) : h59.d(j3, h59.b(j2, j4, RoundingMode.UNNECESSARY)) : h59.b(j3, h59.b(j4, j2, RoundingMode.UNNECESSARY), roundingMode) : h59.d(j2, h59.b(j3, j4, RoundingMode.UNNECESSARY)) : h59.b(j2, h59.b(j4, j3, RoundingMode.UNNECESSARY), roundingMode);
    }
    ...
    */
    public static long Y(long r9, long r11, long r13, java.math.RoundingMode r15) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.vjg.Y(long, long, long, java.math.RoundingMode):long");
    }

    @EnsuresNonNullIf(expression = {"#1"}, result = false)
    public static boolean Z(gdb gdbVar, boolean z) {
        return gdbVar == null || !gdbVar.W() || gdbVar.b() == 1 || gdbVar.b() == 4 || !(!z || gdbVar.L() == 0 || gdbVar.L() == 4);
    }
    ...
    public static int b(a59 a59Var, long j2) {
        int i2 = a59Var.a - 1;
        int i3 = 0;
        while (i3 <= i2) {
            int i4 = (i3 + i2) >>> 1;
    ...
    public static ebe b0(hz8 hz8Var, wu0 wu0Var) {
        ebe ebeVar = new ebe();
        vb0 vb0Var = new vb0(3, ebeVar, hz8Var);
        h54 h54Var = h54.a;
        ebeVar.a(vb0Var, h54Var);
        hz8Var.a(new wf3(2, hz8Var, ebeVar, wu0Var), h54Var);
        return ebeVar;
    }
    ...
    public static Point w(Context context) {
        ...
        if (display.getDisplayId() == 0 && M(context)) {
            String strE = Build.VERSION.SDK_INT < 28 ? E("sys.display-size") : E("vendor.display-size");
            if (!TextUtils.isEmpty(strE)) {
                try {
                    String[] strArrSplit = strE.trim().split("x", -1);
                ...
                zkd.w("Util", "Invalid display size: " + strE);
            }
    ...
    public static long z(long j2, float f2) {
        return f2 == 1.0f ? j2 : Math.round(j2 * ((double) f2));
    }
}
