...
public final class e92 {
    ...
    public e92(InputStream inputStream) {
        this.e = inputStream;
    }
    ...
    public final <T extends rp9> T g(n4b<T> n4bVar, s45 s45Var) throws InvalidProtocolBufferException {
        int iK = k();
        if (this.i >= 64) {
    ...
    */
    public final long l() {
        ...
        Lc1:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.e92.l():long");
    }
    ...
    public final boolean q(int i, f92 f92Var) throws InvalidProtocolBufferException {
        int iN;
        int i2 = i & 7;
        if (i2 == 0) {
            long jL = l();
    ...
    public final boolean s(int i) throws IOException {
        ...
        if (this.g + i2 + i <= this.h && (inputStream = this.e) != null) {
            ...
            if (i6 == 0 || i6 < -1 || i6 > bArr.length) {
                w20.n("InputStream#read(byte[]) returned invalid result: ", 102, i6, "\nThe InputStream implementation is buggy.");
            } else if (i6 > 0) {
                this.b += i6;
