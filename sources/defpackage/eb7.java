...
public final class eb7 implements c9c<a> {
    public final wb7 a;
    ...
    public final ena a() {
        gb7 gb7Var = gb7.a;
        ha.g gVar = ha.a;
        return new ena(gb7Var, false);
    }

    @Override // defpackage.pua
    public final String b() {
        return "query InferredApplicationStatusForEmployerReplyLikelihood($input: InferredApplicationStatusForJobsInput!) { inferredApplicationStatusForJobs(input: $input) { inferredApplicationStatus { job { key } employerReplyLikelihood applicationInsights } } }";
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof eb7) && this.a.equals(((eb7) obj).a);
    }
    ...
    public final String id() {
        return "477a8bbd5afd5aaa769a90bcb1a85b84f3db9941c7fee6f4dcb2306ae9efba42";
    }

    @Override // defpackage.pua
    public final String name() {
        return "InferredApplicationStatusForEmployerReplyLikelihood";
    }

    public final String toString() {
        return "InferredApplicationStatusForEmployerReplyLikelihoodQuery(input=" + this.a + ")";
    }
}
