...
public final class km implements ga<gm.c> {
    ...
    @Override // defpackage.ga
    public final void b(hc8 hc8Var, lb3 lb3Var, gm.c cVar) {
        gm.c cVar2 = cVar;
        hc8Var.getClass();
        lb3Var.getClass();
        cVar2.getClass();
