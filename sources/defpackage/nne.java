...
public final class nne {
    ...
    public nne(int i, int i2, float f, float f2, int i3) {
        this.a = i;
        this.b = i2;
        this.c = f;
        this.d = f2;
        this.e = i / i3;
        this.f = i / DataOkHttpUploader.HTTP_BAD_REQUEST;
        int i4 = i / 65;
        this.g = i4;
        int i5 = i4 * 2;
        this.h = i5;
    ...
    public final void f() {
        ...
        if (d2 > 1.0000100135803223d || d2 < 0.9999899864196777d) {
            ...
            if (i12 >= i13) {
                ...
                while (true) {
                    ...
                    if (i15 > 0) {
                        ...
                        if (d > 1.0d) {
                            ...
                            this.l = sArrC2;
                            System.arraycopy(sArr3, i28 * i10, sArrC2, this.m * i10, i * i10);
                            e(i3, this.b, this.l, this.m + i, sArr3, i28 + i, sArr3, i28);
                            this.m += i29;
                            i14 = i28 + i3;
                        }
                    }
                ...
                int i30 = this.k - i14;
                short[] sArr4 = this.j;
                System.arraycopy(sArr4, i14 * i10, sArr4, 0, i30 * i10);
                this.k = i30;
            }
            if (f != 1.0f || this.m == i7) {
            }
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    while (i33 < i10) {
                        ...
                        sArr5[i34] = (short) ((((j10 - j9) * ((long) s2)) + (((long) s) * j9)) / j10);
                        i33++;
                        i32 = i37;
                        j3 = j7;
                    }
            ...
            short[] sArr7 = this.n;
            System.arraycopy(sArr7, i5 * i10, sArr7, 0, (i4 - i5) * i10);
            this.o -= i5;
            return;
        }
        a(this.j, 0, this.k);
