...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b'\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lbn0;", "Lija;", "<init>", "()V", "reactnative_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
public abstract class bn0 extends ija {
    @Override // defpackage.ija, androidx.fragment.app.Fragment
    public void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        if (((r0g) cr8.p(r0g.class)).b()) {
            return;
        }
        r0g r0gVar = (r0g) cr8.p(r0g.class);
        g gVarRequireActivity = requireActivity();
        gVarRequireActivity.getClass();
        r0gVar.a(gVarRequireActivity, this);
    }
