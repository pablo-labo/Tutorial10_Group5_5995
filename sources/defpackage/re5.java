...
public final class re5 implements ga<ne5.c> {
    ...
    public final ne5.c a(mb8 mb8Var, lb3 lb3Var) {
        ...
        if (u8dVar != null) {
            return new ne5.c(str, str2, u8dVar);
        }
        mh2.q(mb8Var, "status");
        throw null;
    }
    ...
    @Override // defpackage.ga
    public final void b(hc8 hc8Var, lb3 lb3Var, ne5.c cVar) {
        ne5.c cVar2 = cVar;
        hc8Var.getClass();
        lb3Var.getClass();
        cVar2.getClass();
