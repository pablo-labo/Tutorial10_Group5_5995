...
public final class fkg {
    ...
    public static final class a implements GenericArrayType {
        ...
        public final boolean equals(Object obj) {
            return (obj instanceof GenericArrayType) && fkg.b(this, (GenericArrayType) obj);
        }
    ...
    public static final class b implements ParameterizedType {
        ...
        public final boolean equals(Object obj) {
            return (obj instanceof ParameterizedType) && fkg.b(this, (ParameterizedType) obj);
        }
        ...
        public final String toString() {
            ...
            sb.append(fkg.n(type));
            sb.append("<");
            sb.append(fkg.n(typeArr[0]));
            for (int i = 1; i < typeArr.length; i++) {
                sb.append(", ");
                sb.append(fkg.n(typeArr[i]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    public static final class c implements WildcardType {
        ...
        public final boolean equals(Object obj) {
            return (obj instanceof WildcardType) && fkg.b(this, (WildcardType) obj);
        }

        @Override // java.lang.reflect.WildcardType
        public final Type[] getLowerBounds() {
            Type type = this.b;
            return type != null ? new Type[]{type} : fkg.a;
        }
        ...
        public final String toString() {
            Type type = this.b;
            if (type != null) {
                return "? super " + fkg.n(type);
            }
            Type type2 = this.a;
            if (type2 == Object.class) {
                return CoreFeature.DEFAULT_APP_VERSION;
            }
            return "? extends " + fkg.n(type2);
        }
    }
    ...
    public static Type d(int i, ParameterizedType parameterizedType) {
        ...
        StringBuilder sbG = o6.g(i, "Index ", " not in range [0,");
        sbG.append(actualTypeArguments.length);
        sbG.append(") for ");
        sbG.append(parameterizedType);
    ...
    public static IllegalArgumentException i(Method method, Exception exc, String str, Object... objArr) {
        StringBuilder sbG = h5.g(String.format(str, objArr), "\n    for method ");
        sbG.append(method.getDeclaringClass().getSimpleName());
        sbG.append(".");
        sbG.append(method.getName());
        return new IllegalArgumentException(sbG.toString(), exc);
    }

    public static IllegalArgumentException j(Method method, int i, String str, Object... objArr) {
        StringBuilder sbG = h5.g(str, " (parameter #");
        sbG.append(i + 1);
        sbG.append(")");
        return i(method, null, sbG.toString(), objArr);
    }
    ...
    public static IllegalArgumentException k(Method method, Exception exc, int i, String str, Object... objArr) {
        ...
        sbG.append(i + 1);
        sbG.append(")");
        return i(method, exc, sbG.toString(), objArr);
    }
    ...
    */
    public static java.lang.reflect.Type l(java.lang.reflect.Type r8, java.lang.Class<?> r9, java.lang.reflect.Type r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.fkg.l(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type):java.lang.reflect.Type");
    }
