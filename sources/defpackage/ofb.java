...
public final class ofb implements a6b, z91.a, ks2 {
    public final j79 e;
    public final pfb.a f;
    public final boolean g;
    public final boolean h;
    public final di5 i;
    public final z91<?, PointF> j;
    public final di5 k;
    public final di5 l;
    public final di5 m;
    public final di5 n;
    ...
    public final wm2 p = new wm2(0);

    public ofb(j79 j79Var, ba1 ba1Var, pfb pfbVar) {
        this.e = j79Var;
        pfb.a aVar = pfbVar.b;
        this.f = aVar;
        this.g = pfbVar.j;
        this.h = pfbVar.k;
        di5 di5VarT = pfbVar.c.t();
        this.i = di5VarT;
        z91<PointF, PointF> z91VarT = pfbVar.d.t();
        this.j = z91VarT;
        di5 di5VarT2 = pfbVar.e.t();
        this.k = di5VarT2;
        di5 di5VarT3 = pfbVar.g.t();
        this.m = di5VarT3;
        di5 di5VarT4 = pfbVar.i.t();
        this.o = di5VarT4;
        pfb.a aVar2 = pfb.a.STAR;
        if (aVar == aVar2) {
            this.l = pfbVar.f.t();
            this.n = pfbVar.h.t();
        } else {
    ...
    public final Path c() {
        ...
        if (iOrdinal == 0) {
            z = true;
            float fFloatValue = di5Var4.e().floatValue();
            double radians = Math.toRadians((di5Var3 != null ? di5Var3.e().floatValue() : 0.0d) - 90.0d);
            ...
            float fFloatValue2 = di5Var.e().floatValue();
            float fFloatValue3 = this.l.e().floatValue();
            di5 di5Var5 = this.n;
            float fFloatValue4 = di5Var5 != null ? di5Var5.e().floatValue() / 100.0f : 0.0f;
            float fFloatValue5 = di5Var2 != null ? di5Var2.e().floatValue() / 100.0f : 0.0f;
            if (f10 != 0.0f) {
                float fB = k6.b(fFloatValue2, fFloatValue3, f10, fFloatValue3);
                double d4 = fB;
                f4 = fB;
            ...
            PointF pointFE = z91Var.e();
            path.offset(pointFE.x, pointFE.y);
            path.close();
        } else if (iOrdinal != 1) {
            z = true;
        } else {
            int iFloor = (int) Math.floor(di5Var4.e().floatValue());
            double radians2 = Math.toRadians((di5Var3 != null ? di5Var3.e().floatValue() : 0.0d) - 90.0d);
            double d9 = iFloor;
            float fFloatValue6 = di5Var2.e().floatValue() / 100.0f;
            float fFloatValue7 = di5Var.e().floatValue();
