...
public final class yo2 {
    ...
    public yo2(String str, int i2, Bundle bundle) {
        this(1008000300, 7, str, i2, new Bundle(bundle), 0);
    }

    public static yo2 a(Bundle bundle) {
        int i2 = bundle.getInt(g, 0);
        int i3 = bundle.getInt(k, 0);
        String string = bundle.getString(h);
        string.getClass();
        String str = i;
        ka2.l(bundle.containsKey(str));
        ...
        return new yo2(i2, i3, string, i4, bundle2, i5);
    }
    ...
    public yo2(int i2, int i3, String str, int i4, Bundle bundle, int i5) {
        this.a = i2;
        this.b = i3;
        this.c = str;
        this.d = i4;
