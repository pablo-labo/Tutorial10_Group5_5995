...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0007\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lx88;", "Lp91;", "<init>", "()V", "app_playProdRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class x88 extends p91 {
    public static final /* synthetic */ int k0 = 0;
    public final frg j0 = os5.a(this, fwc.a.b(jq6.class), new b(this), new c(this), new d(this));

    @uh3(c = "com.indeed.android.jobsearch.bottomnav.tabs.jpdiscover.JpDiscoverTabWebViewFragment$TopNavContent$1$1$1", f = "JpDiscoverTabWebViewFragment.kt", l = {}, m = "invokeSuspend")
    ...
    public static final class b extends mj8 implements gu5<irg> {
        ...
        public b(x88 x88Var) {
            super(0);
            this.$this_activityViewModels = x88Var;
        }
    ...
    public final void L(int i, androidx.compose.runtime.b bVar) {
        androidx.compose.runtime.c cVarH = bVar.h(1568015266);
        int i2 = i & 1;
        if (cVarH.o(i2, i2 != 0)) {
            ...
            ad4Var.e(cd4.a.D0);
            cd4.i3.a.getClass();
            rm2.a(ne4Var.a(h07.a), bh2.c(-989419806, new xd(ma0VarA, 11), cVarH), cVarH, 56);
        } else {
            cVarH.D();
        }
        i iVarW = cVarH.W();
        if (iVarW != null) {
            iVarW.d = new w91(this, i, 4);
        }
    }
    ...
    public final boolean Y() {
        if (((jq6) this.j0.getValue()).h() == xj1.Y) {
            this.Y.h("JP_DISCOVER");
            if (Z()) {
                ArrayList arrayList = lz2.a;
                lz2.d("JpDiscoverTabWebViewFragment", "handleBackNavigation() -> back in WebView", false, null);
                return true;
            }
        }
        return false;
