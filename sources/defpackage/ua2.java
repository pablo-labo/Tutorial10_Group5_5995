...
public final class ua2 {
    public static ta2 a(ta2 ta2Var) {
        bzg bzgVar = boa.f;
        if (ka2.v(ta2Var.b, 12884901888L)) {
            abd abdVar = (abd) ta2Var;
            bzg bzgVar2 = abdVar.d;
            if (!c(bzgVar2, bzgVar)) {
                return new abd(abdVar.a, abdVar.h, bzgVar, f(b(da.b.a, bzgVar2.a(), bzgVar.a()), abdVar.i), abdVar.k, abdVar.n, abdVar.e, abdVar.f, abdVar.g, -1);
            }
        }
        return ta2Var;
    }
    ...
    public static final boolean c(bzg bzgVar, bzg bzgVar2) {
        if (bzgVar == bzgVar2) {
            return true;
        }
        return Math.abs(bzgVar.a - bzgVar2.a) < 0.001f && Math.abs(bzgVar.b - bzgVar2.b) < 0.001f;
    }

    public static final ip2 d(ta2 ta2Var, ta2 ta2Var2) {
        return ta2Var == ta2Var2 ? new hp2(ta2Var, ta2Var, 1) : (ka2.v(ta2Var.b, 12884901888L) && ka2.v(ta2Var2.b, 12884901888L)) ? new ip2.a((abd) ta2Var, (abd) ta2Var2) : new ip2(ta2Var, ta2Var2, 0);
    }
