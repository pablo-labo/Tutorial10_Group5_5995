...
public final class x61 {
    ...
    public static class a implements pk6.c {
        ...
        public final eoe a(sif sifVar) {
                        ...
                        if (TracingInterceptor.B3_HEADER_KEY.equalsIgnoreCase(lowerCase)) {
                            ...
                            if (strArrSplit.length >= 2 && strArrSplit.length <= 4) {
                                ...
                                if (length > 32) {
                                    ...
                                    bve bveVarB = pk6.b(16, length > 16 ? strArrSplit[0].substring(length - 16) : strArrSplit[0]);
                                    bigIntegerC = pk6.c(16, strArrSplit[1]);
                                    if (strArrSplit.length >= 3) {
                                        if (Integer.parseInt(strArrSplit[2]) != 1) {
                                            i2 = 0;
                                        }
                                        i = i2;
                                    }
            ...
            l55 l55Var = new l55(bigInteger, bigIntegerC, i, null, Collections.EMPTY_MAP, map);
            l55Var.g.set(true);
            return l55Var;
        }
    }
    ...
    public static class b implements pk6.d {
        ...
        public final void a(sc3 sc3Var, uif uifVar) {
            try {
                ...
                if (!sc3Var.d()) {
                    uifVar.a(TracingInterceptor.B3_HEADER_KEY, lowerCase + "-" + lowerCase2);
                    return;
                }
                uifVar.a(TracingInterceptor.B3_HEADER_KEY, lowerCase + "-" + lowerCase2 + "-" + (sc3Var.c() > 0 ? x61.a : x61.b));
