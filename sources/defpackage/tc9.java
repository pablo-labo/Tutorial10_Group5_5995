...
public final class tc9 implements ga<qc9.b> {
    public static final tc9 a = new tc9();
    public static final List<String> b = u63.a0("resumeId", "tags");

    @Override // defpackage.ga
    public final qc9.b a(mb8 mb8Var, lb3 lb3Var) {
        mb8Var.getClass();
        lb3Var.getClass();
        String str = null;
        ...
        if (arrayList != null) {
            return new qc9.b(str, arrayList);
        }
        mh2.q(mb8Var, "tags");
        throw null;
    }
    ...
    @Override // defpackage.ga
    public final void b(hc8 hc8Var, lb3 lb3Var, qc9.b bVar) {
        qc9.b bVar2 = bVar;
        hc8Var.getClass();
        lb3Var.getClass();
        bVar2.getClass();
