...
public final /* synthetic */ class u1e extends qv5 implements gu5<j6g> {
    @Override // defpackage.gu5
    public final j6g invoke() {
        Object value;
        y1e y1eVar = (y1e) this.receiver;
        y1eVar.getClass();
        ((tp7) cr8.p(tp7.class)).b(new sp7.b("messagingAttachmentBanner", "attachmentBannerDismiss", null, null, 12));
