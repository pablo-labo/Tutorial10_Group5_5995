...
public interface nq9 extends b {
    @Override // com.indeed.android.backendservices.common.api.b
    default wg0.a a(Exception exc) {
        ArrayList arrayList = lz2.a;
        lz2.c("RNMessagingApiTask", bg.e(exc, "API Error in HttpResponse: "), false, null, 12);
    ...
    default wg0.a b(int i, String str) {
        ...
        if (str2.length() > 0) {
            ArrayList arrayList = lz2.a;
            lz2.c("RNMessagingApiTask", l5.l("ApiError from ApiResponse: ", str), false, null, 12);
        }
