...
public final class fah {
    public static final jfe a = new jfe();
    public static Locale b;

    public static String a(Context context) {
        String packageName = context.getPackageName();
        try {
            Context context2 = a5h.a(context).a;
    ...
    public static String b(Context context, int i) {
        ...
        if (i == 2) {
            return pnb.F(context) ? resources.getString(R.string.common_google_play_services_wear_update_text) : resources.getString(R.string.common_google_play_services_update_text, strA);
        }
        if (i == 3) {
    ...
    public static String e(Context context, String str) {
        ...
        synchronized (jfeVar) {
            try {
                ...
                String str2 = (String) jfeVar.get(str);
                if (str2 != null) {
                    return str2;
                }
                int i = ab6.e;
