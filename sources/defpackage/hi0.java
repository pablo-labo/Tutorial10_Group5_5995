...
public final class hi0 extends mj8 implements Function2<b, Integer, j6g> {
    final /* synthetic */ wu5<fhd, b, Integer, j6g> $actions;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public hi0(wu5<? super fhd, ? super b, ? super Integer, j6g> wu5Var) {
        super(2);
        this.$actions = wu5Var;
    }
    ...
    public final j6g invoke(b bVar, Integer num) {
        ...
        if ((num.intValue() & 3) == 2 && bVar2.i()) {
            ...
            wu5<fhd, b, Integer, j6g> wu5Var = this.$actions;
