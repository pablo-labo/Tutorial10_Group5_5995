...
public final class hog implements mog {
    public final WeakReference<VideoPlayer> a;
    public a c;
    public cqf d;
    public final LinkedHashMap b = new LinkedHashMap();
    public final ArrayList<AudioTrack> e = new ArrayList<>();

    public hog(VideoPlayer videoPlayer) {
    ...
    public final a a() {
        ...
        e47<String> e47Var = dqfVarP != null ? dqfVarP.p : null;
    ...
    public final void b(boolean z) {
        ...
        dqf dqfVarB = dqfVarP.a().m(1, !z).b();
        if (!z) {
            dqfVarB = dqfVarB.a().d(1).b();
        }
    ...
    public final void onTracksChanged(VideoPlayer videoPlayer, wqf wqfVar) {
        ...
        linkedHashMap.clear();
        ArrayList<AudioTrack> arrayList = this.e;
        arrayList.clear();
        ...
        while (bVarListIterator.hasNext()) {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                ...
                if (st9.k(aVarA.n)) {
                    ...
                    AudioTrack.INSTANCE.getClass();
                    AudioTrack audioTrackA = AudioTrack.Companion.a(aVarA);
                    if (audioTrackA != null) {
                        arrayList.add(audioTrackA);
                    }
                }
            }
        }
