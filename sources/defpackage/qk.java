...
public final class qk implements ga<mk.c> {
    ...
    public final mk.c a(mb8 mb8Var, lb3 lb3Var) {
        ...
        if (h68Var != null) {
            return new mk.c(h68Var, strA, strA2, strA3);
        }
    ...
    @Override // defpackage.ga
    public final void b(hc8 hc8Var, lb3 lb3Var, mk.c cVar) {
        mk.c cVar2 = cVar;
        hc8Var.getClass();
        lb3Var.getClass();
        cVar2.getClass();
