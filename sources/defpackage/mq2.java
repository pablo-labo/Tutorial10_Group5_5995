...
public final class mq2 {
    ...
    public static final void k(int i, int i2) {
        throw new IllegalArgumentException(w40.e("Can't represent a width of ", i, " and height of ", i2, " in Constraints"));
    }

    public static final Void l(int i) {
        throw new IllegalArgumentException(bg.d(i, "Can't represent a size of ", " in Constraints"));
    }
}
