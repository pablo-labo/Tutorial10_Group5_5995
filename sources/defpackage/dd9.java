...
@o7e
public final class dd9 extends d4f {
    ...
    @sy3
    public static final /* synthetic */ class a implements sw5<dd9> {
        ...
        static {
            a aVar = new a();
            a = aVar;
            PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("markdown", aVar, 8);
            ...
            pluginGeneratedSerialDescriptor.k("markdown", false);
        ...
        public final Object deserialize(Decoder decoder) {
            ...
            return new dd9(i, str, bool, str2, str3, str4, iM, strO, str5);
        }
        ...
        public final void serialize(Encoder encoder, Object obj) {
            ...
            d4f.a(dd9Var, vl2VarB, serialDescriptor);
            int i = dd9Var.i;
            String str = dd9Var.k;
            vl2VarB.r(5, i, serialDescriptor);
            vl2VarB.x(serialDescriptor, 6, dd9Var.j);
    ...
    public static final class b {
        public final KSerializer<dd9> serializer() {
            return a.a;
        }
    }
    ...
    public static final class d {
        ...
        static {
            d dVar = new d("Contrast", 0);
            d dVar2 = new d(ReactProgressBarViewManager.DEFAULT_STYLE, 1);
            b = dVar2;
            d[] dVarArr = {dVar, dVar2, new d("Secondary", 2), new d("Alert", 3), new d("Success", 4)};
            c = dVarArr;
            d = new wv4(dVarArr);
            a = new a();
        }
    ...
    public dd9(int i, String str, Boolean bool, String str2, String str3, String str4, int i2, String str5, String str6) {
        Object next;
        Object next2;
        ...
        if (str7 != null) {
            ...
            d dVar2 = (d) next2;
            if (dVar2 == null) {
                l5.q("Unknown variant: ".concat(str7));
                throw null;
            }
            dVar = dVar2;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        dd9 dd9Var = (dd9) obj;
        return this.i == dd9Var.i && wl7.b(this.j, dd9Var.j) && wl7.b(this.k, dd9Var.k);
    }
    ...
    public final String toString() {
        return l6.i(m6.j(this.i, "MarkdownComponent(level=", ", markdown=", this.j, ", variant="), this.k, ")");
    }
}
