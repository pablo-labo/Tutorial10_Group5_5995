...
public final class ck0 {
    ...
    public static class b extends d {
        ...
        public void a(StaticLayout.Builder builder, TextView textView) {
            builder.setTextDirection((TextDirectionHeuristic) ck0.e("getTextDirectionHeuristic", textView, TextDirectionHeuristics.FIRSTSTRONG_LTR));
        }
    }
    ...
    public static class d {
        ...
        public boolean b(TextView textView) {
            return ((Boolean) ck0.e("getHorizontallyScrolling", textView, Boolean.FALSE)).booleanValue();
        }
    }

    public ck0(TextView textView) {
        this.i = textView;
    ...
    public final int c(RectF rectF) {
        ...
        if (length == 0) {
            r6.g("No available text sizes to choose from.");
            return 0;
        }
        int i = length - 1;
        int i2 = 0;
        ...
        while (true) {
            ...
            StaticLayout staticLayoutA = a.a(charSequence, (Layout.Alignment) e("getLayoutAlignment", textView, Layout.Alignment.ALIGN_NORMAL), Math.round(rectF.right), maxLines, this.i, this.h, this.k);
    ...
    public final void k(float f, float f2, float f3) {
        ...
        if (f2 <= f) {
            q6.i("Maximum auto-size text size (", f2, "px) is less or equal to minimum auto-size text size (", f, "px)");
            return;
        }
        if (f3 <= 0.0f) {
