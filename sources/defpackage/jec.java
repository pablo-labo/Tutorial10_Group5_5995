...
public final /* synthetic */ class jec implements wu5 {
    public final /* synthetic */ int a;
    public final /* synthetic */ gu5 b;

    public /* synthetic */ jec(int i, gu5 gu5Var) {
        this.a = i;
        this.b = gu5Var;
    }
        ...
        switch (i) {
            case 0:
                ...
                if (bVar.o(iIntValue & 1, (iIntValue & 17) != 16)) {
                    ...
                    Object objV = bVar.v();
                    if (zK || objV == b.a.a) {
                        objV = new ni(6, gu5Var);
                        bVar.p(objV);
                    }
                    nec.f((gu5) objV, bVar, 0);
                } else {
                    bVar.D();
                }
                break;
