...
public final class a46 implements ga<s36.g> {
    ...
    public final s36.g a(mb8 mb8Var, lb3 lb3Var) {
        mb8Var.getClass();
        lb3Var.getClass();
        String strA = null;
        String strA2 = null;
        ...
        while (true) {
            switch (mb8Var.D1(b)) {
                ...
                case 8:
                    ...
                    break;
                default:
                    return new s36.g(strA, strA2, strA3, strA4, strA5, strA6, strA7, strA8, strA9);
            }
        }
    }

    @Override // defpackage.ga
    public final void b(hc8 hc8Var, lb3 lb3Var, s36.g gVar) {
        s36.g gVar2 = gVar;
        hc8Var.getClass();
        lb3Var.getClass();
        gVar2.getClass();
        ...
        hc8Var.u0("location");
        nmaVar.b(hc8Var, lb3Var, gVar2.g);
        hc8Var.u0("postalCode");
        nmaVar.b(hc8Var, lb3Var, gVar2.h);
        hc8Var.u0("state");
        nmaVar.b(hc8Var, lb3Var, gVar2.i);
    }
}
