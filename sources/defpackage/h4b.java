...
public final class h4b {
    ...
    public h4b(byte[] bArr, int i, int i2) {
        this.a = bArr;
        this.c = i;
        this.b = i2;
        a();
    ...
    public final void a() {
        int i;
        int i2 = this.c;
        ka2.q(i2 >= 0 && (i2 < (i = this.b) || (i2 == i && this.d == 0)));
    }
    ...
    public final boolean d() {
        boolean z = (this.a[this.c] & (IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT >> this.d)) != 0;
        i();
        return z;
    }
