    ...
    */
    public static int a(java.lang.CharSequence r9) {
        ...
        L8b:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bf1.a(java.lang.CharSequence):int");
    }
    ...
    */
    public static int b(java.lang.CharSequence r6) {
        ...
        L3f:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bf1.b(java.lang.CharSequence):int");
    }
    ...
    public final SpannableStringBuilder c(CharSequence charSequence) {
        ...
        boolean zB2 = (zB ? tdf.b : tdf.a).b(charSequence, charSequence.length());
        String str = "";
        String str2 = c;
        String str3 = b;
        boolean z = this.a;
        spannableStringBuilder.append((CharSequence) ((z || !(zB2 || a(charSequence) == 1)) ? (!z || (zB2 && a(charSequence) != -1)) ? "" : str2 : str3));
        if (zB != z) {
        ...
        boolean zB3 = (zB ? tdf.b : tdf.a).b(charSequence, charSequence.length());
