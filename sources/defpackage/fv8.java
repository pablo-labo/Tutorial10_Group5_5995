...
public final class fv8 implements ga<cv8.b> {
    ...
    public final cv8.b a(mb8 mb8Var, lb3 lb3Var) {
        mb8Var.getClass();
        lb3Var.getClass();
        String strA = null;
        String strA2 = null;
        ...
        while (true) {
            switch (mb8Var.D1(b)) {
                ...
                case 8:
                    ...
                    break;
                default:
                    return new cv8.b(strA, strA2, strA3, strA4, strA5, strA6, strA7, strA8, strA9);
            }
        }
    }

    @Override // defpackage.ga
    public final void b(hc8 hc8Var, lb3 lb3Var, cv8.b bVar) {
        cv8.b bVar2 = bVar;
        hc8Var.getClass();
        lb3Var.getClass();
        bVar2.getClass();
