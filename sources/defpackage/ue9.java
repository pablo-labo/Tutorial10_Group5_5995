...
public final class ue9 extends cj0 {
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.e == null) {
            ...
            int iZ2 = hh1.z(this, com.indeed.android.jobsearch.R.attr.colorSurface);
            int iZ3 = hh1.z(this, com.indeed.android.jobsearch.R.attr.colorOnSurface);
            this.e = new ColorStateList(V, new int[]{hh1.G(iZ2, 1.0f, iZ), hh1.G(iZ2, 0.54f, iZ3), hh1.G(iZ2, 0.38f, iZ3), hh1.G(iZ2, 0.38f, iZ3)});
        }
        return this.e;
    }
