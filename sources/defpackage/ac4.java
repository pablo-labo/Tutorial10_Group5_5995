...
public final class ac4 {
    ...
    public static class a {
        ...
        static {
            ...
            L63:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: ac4.a.<clinit>():void");
        }
    }
    ...
    public static Rect b(Drawable drawable) {
        ...
        boolean z = drawable instanceof w4h;
        Object objA = drawable;
        if (z) {
            objA = ((w4h) drawable).a();
        }
        if (i >= 29) {
            ...
            try {
                Object objInvoke = a.b.invoke(objA, null);
                if (objInvoke != null) {
