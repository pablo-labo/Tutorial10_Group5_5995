...
public final class ub7 implements ga<qb7.c> {
    ...
    public final qb7.c a(mb8 mb8Var, lb3 lb3Var) {
        ...
        while (mb8Var.D1(b) == 0) {
            tb7 tb7Var = tb7.a;
            ha.g gVar = ha.a;
            ena enaVar = new ena(tb7Var, false);
            mb8Var.m();
    ...
    @Override // defpackage.ga
    public final void b(hc8 hc8Var, lb3 lb3Var, qb7.c cVar) {
        qb7.c cVar2 = cVar;
        hc8Var.getClass();
        lb3Var.getClass();
        cVar2.getClass();
