...
public final class t39 {
    public static final void a(gu5<j6g> gu5Var, b bVar, int i) {
        gu5Var.getClass();
        c cVarH = bVar.h(832916549);
        int i2 = (cVarH.x(gu5Var) ? 4 : 2) | i;
        if (cVarH.o(i2 & 1, (i2 & 3) != 2)) {
            o97 o97Var = (o97) cVarH.M(p97.a);
            e.a aVar = e.a.b;
            e eVarM = pnb.M(f.f(a.b(g.d(aVar, 1.0f), o97Var.c.b.a, ytc.a), 16.0f), pnb.L(0, 1, cVarH), true);
            ...
            e eVarH = f.h(g.f(aVar, 1.0f), 16.0f, 0.0f, 2);
            ...
            gt6.h(ak2.I(R.string.sign_in, cVarH), gu5Var, g.f(aVar, 1.0f), null, false, false, null, null, null, cVarH, ((i2 << 3) & 112) | 384, DataOkHttpUploader.HTTP_GATEWAY_TIMEOUT);
            cVarH.U(true);
            cVarH.U(true);
        } else {
            cVarH.D();
