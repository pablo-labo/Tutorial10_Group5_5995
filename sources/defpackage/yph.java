...
public final class yph {
    ...
    */
    public yph(java.lang.String r4, char[] r5, byte[] r6, boolean r7) {
        /*
            r3 = this;
            r3.<init>()
            r3.a = r4
            ...
            if (r4 <= 0) goto L7d
            int[] r1 = defpackage.lqh.a     // Catch: java.lang.ArithmeticException -> L73
        ...
        L85:
            ...
            java.lang.String r4 = defpackage.p6.c(r4, r6)
            r5.<init>(r4, r3)
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.yph.<init>(java.lang.String, char[], byte[], boolean):void");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        yph yphVar = (yph) obj;
        return this.h == yphVar.h && Arrays.equals(this.b, yphVar.b);
    }
    ...
    public yph(String str, char[] cArr) {
        ...
        for (int i = 0; i < cArr.length; i++) {
            ...
            if (c < 128) {
                if (bArr[c] == -1) {
                    ...
                    l5.q(ejh.a("Duplicate character: %s", Character.valueOf(c)));
                    throw null;
                }
            } else {
                l5.q(ejh.a("Non-ASCII character: %s", Character.valueOf(c)));
                throw null;
            }
        }
