...
public class vj0 {
    ...
    public vj0(AbsSeekBar absSeekBar) {
        this.a = absSeekBar;
    }

    public void a(AttributeSet attributeSet, int i) {
        AbsSeekBar absSeekBar = this.a;
        umf umfVarE = umf.e(absSeekBar.getContext(), attributeSet, c, i);
        ...
        Drawable drawableC2 = umfVarE.c(1);
        if (drawableC2 != null) {
    ...
    public final Drawable b(Drawable drawable, boolean z) {
        if (drawable instanceof w4h) {
            w4h w4hVar = (w4h) drawable;
            Drawable drawableA = w4hVar.a();
            if (drawableA != null) {
                b(drawableA, z);
                w4hVar.b();
                return drawable;
