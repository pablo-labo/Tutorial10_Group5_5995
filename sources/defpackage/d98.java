...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0007\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Ld98;", "Lp91;", "<init>", "()V", "app_playProdRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class d98 extends p91 {
    public static final /* synthetic */ int k0 = 0;
    public final frg j0 = os5.a(this, fwc.a.b(jq6.class), new b(this), new c(this), new d(this));

    @uh3(c = "com.indeed.android.jobsearch.bottomnav.tabs.jpmyjobs.JpMyJobsTabWebViewFragment$TopNavContent$1$1$1", f = "JpMyJobsTabWebViewFragment.kt", l = {}, m = "invokeSuspend")
    ...
    public static final class b extends mj8 implements gu5<irg> {
        ...
        public b(d98 d98Var) {
            super(0);
            this.$this_activityViewModels = d98Var;
        }
    ...
    public final void L(int i, androidx.compose.runtime.b bVar) {
        androidx.compose.runtime.c cVarH = bVar.h(1798195465);
        int i2 = i & 1;
        if (cVarH.o(i2, i2 != 0)) {
            ...
            ad4Var.e(cd4.a.D0);
            cd4.i3.a.getClass();
            rm2.a(ne4Var.a(h07.a), bh2.c(1741315145, new e45(ma0VarA, 4), cVarH), cVarH, 56);
        } else {
            cVarH.D();
        }
        i iVarW = cVarH.W();
        if (iVarW != null) {
            iVarW.d = new lr(this, i, 6);
        }
    }
    ...
    public final boolean Y() {
        if (((jq6) this.j0.getValue()).h() == xj1.Z) {
            this.Y.h("JP_MYJOBS");
            if (Z()) {
                ArrayList arrayList = lz2.a;
                lz2.d("JpMyJobsTabWebViewFragment", "handleBackNavigation() -> back in WebView", false, null);
                return true;
            }
        }
        return false;
