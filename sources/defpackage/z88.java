...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0007\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lz88;", "Lp91;", "<init>", "()V", "app_playProdRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class z88 extends p91 {
    public static final /* synthetic */ int m0 = 0;
    public final xj1 j0 = xj1.X;
    public final frg k0;
    public final frg l0;

    @uh3(c = "com.indeed.android.jobsearch.bottomnav.tabs.home.JpHomeTabWebViewFragment$TopNavContent$1$1$1", f = "JpHomeTabWebViewFragment.kt", l = {}, m = "invokeSuspend")
    ...
    public static final class b extends mj8 implements gu5<irg> {
        ...
        public b(z88 z88Var) {
            super(0);
            this.$this_activityViewModels = z88Var;
        }
    ...
    public z88() {
        iwc iwcVar = fwc.a;
        this.k0 = os5.a(this, iwcVar.b(jq6.class), new b(this), new c(this), new d(this));
        this.l0 = os5.a(this, iwcVar.b(c6f.class), new e(this), new f(this), new g(this));
    }

    @Override // defpackage.p91
    public final void L(int i, androidx.compose.runtime.b bVar) {
        androidx.compose.runtime.c cVarH = bVar.h(-574187790);
        int i2 = i & 1;
        if (cVarH.o(i2, i2 != 0)) {
            ...
            ad4Var.e(cd4.a.D0);
            cd4.i3.a.getClass();
            rm2.a(ne4Var.a(h07.a), bh2.c(-867571150, new kh(ma0VarA, 6), cVarH), cVarH, 56);
        } else {
            cVarH.D();
        }
        i iVarW = cVarH.W();
        if (iVarW != null) {
            iVarW.d = new v02(this, i, 4);
        }
    }
    ...
    public final boolean Y() {
        if (((jq6) this.k0.getValue()).h() == xj1.X) {
            this.Y.h("JP_HOME");
            if (Z()) {
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        ((c6f) this.l0.getValue()).l(this.j0).a.e(getViewLifecycleOwner(), new a98(new hp0(this, 9)));
    }
}
